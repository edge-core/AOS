...
{
    if (CGI_MAIN_InitiateSystemResources()!= TRUE)
    {
        printf("\r\nInitiate CGI_MAIN_Initiate_System_Resources() Error!!");
    }
}
...
{
    CGI_MAIN_Create_InterCSC_Relation();
}
 ...
 *       CGI_INIT_InitiateSystemResources() is performed
 *---------------------------------------------------------------------------
 */
