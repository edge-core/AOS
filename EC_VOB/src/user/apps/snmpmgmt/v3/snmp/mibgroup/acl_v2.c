                                          ...
                                          oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          /* In reserve2, we overwrite the set value to aclIngressIpMaskEntry*/
          aclIngressIpMaskEntry.u.ip_mask.SourceIpAddrBitmask = *(u_long *)var_val;
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          /* In reserve2, we overwrite the set value to aclIngressIpMaskEntry*/
          &aclIngressIpMaskEntry.u.ip_mask.DestIpAddrBitmask = *(u_long *)var_val;
          break;
        case FREE:
             /* Release any resources that have been allocated */
          break;
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclIngressIpMaskEntry*/
          aclIngressIpMaskEntry.u.ip_mask.DestIpAddrBitmask = *(long *)var_val;
                                      ...
                                      oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
           ...
           /* In reserve2, we overwrite the set value to aclIngressIpMaskEntry*/
          aclIngressIpMaskEntry.u.ip_mask.DestPortBitmask = *(long *)var_val;
                                         ...
                                         oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclIngressIpMaskEntry*/
          aclIngressIpMaskEntry.u.ip_mask.ControlCodeBitmask = *(long *)var_val;
                             ...
                             u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
           ...
           /* In reserve2, we overwrite the set value to aclIngressIpMaskEntry*/
          aclIngressIpMaskEntry.u.ip_mask.RowStatus = *(long *)var_val;
                                         ...
                                         oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          aclEngressIpMaskEntry.u.ip_mask.SourceIpAddrBitmask = *(u_long *)var_val;
          break;
                                       ...
                                       oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          /* In reserve2, we overwrite the set value to aclEngressIpMaskEntry*/
          aclEngressIpMaskEntry.u.ip_mask.DestIpAddrBitmask = *(u_long *)var_val;
          break;
                                       ...
                                       oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
           ...
           /* In reserve2, we overwrite the set value to aclEngressIpMaskEntry*/
          aclEngressIpMaskEntry.u.ip_mask.SourcePortBitmask = *(long *)var_val;
                                     ...
                                     oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclEngressIpMaskEntry*/
          aclEngressIpMaskEntry.u.ip_mask.DestPortBitmask = *(long *)var_val;
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclEngressIpMaskEntry*/
          aclEngressIpMaskEntry.u.ip_mask.ControlCodeBitmask = *(long *)var_val;
                            ...
                            u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action )
    {
        ...
        case RESERVE2:
             /* In reserve2, we overwrite the set value to aclEngressIpMaskEntry*/
             aclEngressIpMaskEntry.u.ip_mask.RowStatus = *(long *)var_val;
    ...
    switch ( action ) {
        ...
        case RESERVE2:
         /* In reserve2, we overwrite the set value to aclIngressMacMaskEntry*/
          memcpy(aclIngressMacMaskEntry.u.mac_mask.SourceMacAddrBitmask, var_val, var_val_len);
          break;
        case FREE:
             /* Release any resources that have been allocated */
          break;
                                          ...
                                          oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
        /* In reserve2, we overwrite the set value to aclIngressMacMaskEntry*/
          memcpy(aclIngressMacMaskEntry.u.mac_mask.DestMacAddrBitmask, var_val, var_val_len);
          break;
                                  ...
                                  oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclIngressMacMaskEntry*/
          aclIngressMacMaskEntry.u.mac_mask.VidBitmask = *(long *)var_val;
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclIngressMacMaskEntry*/
          aclIngressMacMaskEntry.u.mac_mask.EtherTypeBitmask = *(long *)var_val;
                              ...
                              u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
           ...
           /* In reserve2, we overwrite the set value to aclIngressMacMaskEntry*/
          aclIngressMacMaskEntry.u.mac_mask.RowStatus = *(long *)var_val;
    ...
    switch ( action ) {
        ...
        case RESERVE2:
         /* In reserve2, we overwrite the set value to aclEgressMacMaskEntry*/
          memcpy(aclEgressMacMaskEntry.u.mac_mask.SourceMacAddrBitmask, var_val, var_val_len);
          break;
                                         ...
                                         oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
        /* In reserve2, we overwrite the set value to aclEgressMacMaskEntry*/
          memcpy(aclEgressMacMaskEntry.u.mac_mask.DestMacAddrBitmask, var_val, var_val_len);
          break;
                                 ...
                                 oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
           ...
           /* In reserve2, we overwrite the set value to aclEgressMacMaskEntry*/
          aclEgressMacMaskEntry.u.mac_mask.VidBitmask = *(long *)var_val;
                                       ...
                                       oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case RESERVE2:
          ...
          /* In reserve2, we overwrite the set value to aclEgressMacMaskEntry*/
          aclEgressMacMaskEntry.u.mac_mask.EtherTypeBitmask = *(long *)var_val;
                             ...
                             u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action )
    {
        ...
        case RESERVE2:
             /* In reserve2, we overwrite the set value to aclEgressMacMaskEntry*/
             aclEgressMacMaskEntry.u.mac_mask.RowStatus = *(long *)var_val;
