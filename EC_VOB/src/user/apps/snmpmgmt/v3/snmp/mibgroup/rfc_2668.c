...
init_ifMauTable(void)
{
     ...
     */
     REGISTER_SYSOR_ENTRY(mau_mib_module_oid,
                         "The Rfc 2668 MAU MIB.");

}

static int
header_ifMauTable(struct variable *vp,
               oid * name,
               size_t * length,
...
#define OID_NAME_LENGTH	11
  ...
  while (  (return_val= SWCTRL_GetNextIfMauEntry( &entry))==TRUE)
     {
               ...
               int exact, size_t * var_len, WriteMethod ** write_method)
{
   ...
   /*Since this table allow for entry that does not exist, (creation). we need to know the write method first*/
    ...
    memset( &entry, 0, sizeof(entry));
     ...
     retval  = header_ifMauTable(vp, name, length, exact, var_len, write_method,  &index1,& index2);
  ...
  entry.ifMauIndex = index2;
   ...
   if (SWCTRL_GetIfMauEntry(&entry)!= TRUE)
            return NULL;
    ...
    switch (vp->magic) {
      ...
      case IFMAUTYPELISTBITS:
        memcpy(return_buf, &entry.ifMauTypeListBits, 4);
        *var_len = 4;
                  ...
                  u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case ACTION:
            ...
            if (SWCTRL_SetIfMauStatus(name[11], name[12], ifMauStatus) != TRUE)
                       ...
                       u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action )
    {
        ...
        case ACTION:
            ...
            if (SWCTRL_SetIfMauDefaultType(name[11], name[12], oid[8]) != TRUE)
                return SNMP_ERR_COMMITFAILED;
          break;
...
#define OID_NAME_LENGTH	11
  ...
  while (  (return_val= SWCTRL_GetNextIfJackEntry( &entry))==TRUE)
     {
       next_inst[0] = entry.ifMauIfIndex;
       next_inst[1] = entry.ifMauIndex;
                ...
                int exact, size_t * var_len, WriteMethod ** write_method)
{
    ...
    UI32_T index1, index2, index3,retval;
  ...
  entry.ifJackIndex= index3;
   ...
   if (SWCTRL_GetIfJackEntry(&entry)!= TRUE)
            return NULL;
...
static int
header_ifMauAutoNegTable(struct variable *vp,
               oid * name,
               size_t * length,
               int exact, size_t * var_len, WriteMethod ** write_method,
               UI32_T *index1, UI32_T *index2);
...
#define OID_NAME_LENGTH	11
  ...
  while (  (return_val= SWCTRL_GetNextIfMauAutoNegEntry( &entry))==TRUE)
     {
       next_inst[0] = entry.ifMauIfIndex;
       next_inst[1] = entry.ifMauIndex;
                      ...
                      size_t * var_len, WriteMethod ** write_method)
{
    ...
    memset( &entry, 0, sizeof(entry));
     ...
     retval  = header_ifMauAutoNegTable(vp, name, length, exact, var_len, write_method,  &index1,& index2);
  ...
  entry.ifMauIndex = index2;
   ...
   if (SWCTRL_GetIfMauAutoNegEntry(&entry)!= TRUE)
            return NULL;
                              ...
                              u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case ACTION:
            ...
            if (SWCTRL_SetIfMauAutoNegAdminStatus(name[11], name[12], ifMauAutoNegAdminStatus) != TRUE)
                return SNMP_ERR_COMMITFAILED;
          break;
                          ...
                          u_char * statP, oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case ACTION:
            ...
            if (SWCTRL_SetIfMauAutoNegRestart(name[11], name[12], ifMauAutoNegRestart) != TRUE)
                return SNMP_ERR_COMMITFAILED;
          break;
                                    ...
                                    oid * name, size_t name_len)
{
    ...
    case ACTION:
        ...
        IfMauAutoNegCapAdvertisedBits = L_STDLIB_Ntoh32(IfMauAutoNegCapAdvertisedBits);
         if (SWCTRL_SetIfMauAutoNegCapAdvertisedBits(name[11], name[12], IfMauAutoNegCapAdvertisedBits) != TRUE)
                return SNMP_ERR_COMMITFAILED;
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    switch ( action ) {
        ...
        case ACTION:
            ...
            if (SWCTRL_SetIfMauAutoNegRemoteFaultAdvertised(name[11], name[12], ifMauAutoNegRemoteFaultAdvertised) != TRUE)
                return SNMP_ERR_COMMITFAILED;
          break;
