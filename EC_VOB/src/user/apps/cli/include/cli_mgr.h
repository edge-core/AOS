...
typedef struct
{
    ...
    union
    {
        struct CLI_MGR_IPCMsg_UI32_Data_S
        {
            UI32_T ui32;
        } ui32_data;
        ...
        struct CLI_MGR_IPCMsg_Max_Command_Privilege_S
        {
            UI16_T  cmd_idx;
            UI8_T   privilege_mode;
        } max_command_privilege_data;

#if (SYS_CPNT_CLI_ADD_TO_RUNNING_CONFIG == TRUE)
        struct CLI_MGR_IPCMsg_Create_AddRunconfig_Entry_S
        {
            char    commands[SYS_TYPE_1K_BYTES + 1];
            UI32_T  id;
        } create_addrunconfig_entry_data;

        struct CLI_MGR_IPCMsg_Get_AddRunconfig_Entry_S
        {
            UI32_T  id;
            CLI_OM_EXP_ADDRUNCONFIG_ENTRY_T entry;
        } get_addrunconfig_entry_data;
#endif /* SYS_CPNT_CLI_ADD_TO_RUNNING_CONFIG */
...
#if (SYS_CPNT_CLI_ADD_TO_RUNNING_CONFIG == TRUE)
    CLI_MGR_IPC_PARTIAL_PROVISION,
    CLI_MGR_IPC_ADDRUNCONFIG_CREATE_ENTRY,
    CLI_MGR_IPC_ADDRUNCONFIG_DELETE_ENTRY_BY_ID,
    CLI_MGR_IPC_ADDRUNCONFIG_GET_ENTRY_BY_ID,
#endif /* SYS_CPNT_CLI_ADD_TO_RUNNING_CONFIG */

    CLI_MGR_IPC_GET_MAX_COMMAND_PRIVILEGE,
};
 ...
 *            and free the buffer allocated by BUFFER_MGR
