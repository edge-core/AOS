...
enum
{
    ...
    CLI_TYPE_TRACE_ID_CLI_API_SHOW_ACCESSLIST_TCAMUTILIZATION,
};
...
typedef struct
{
    UI32_T  startup_by_factory_default  : 1;
    UI32_T  reproduce_done              : 1;
    UI32_T  reserved_bits               : 30;
} CLI_TYPE_WorkingFlag_T;

typedef enum
{
    CLI_TYPE_RETURN_OK       =0,
    CLI_TYPE_RETURN_FAIL,
    CLI_TYPE_RETURN_INVALID_ARG,
    CLI_TYPE_RETURN_MASTER_MODE_ERROR
}CLI_TYPE_ReturnValue_T;
#endif
