...
#define CLI_TASK_MAX_PARTIAL_PROVISION_SESSION_NUM  1
...
#define CLI_TASK_MAX_SESSION_NUM                   (CLI_TASK_MAX_CONSOLE_SESSION_NUM        \
                                                    ...
                                                    + CLI_TASK_MAX_PARTIAL_PROVISION_SESSION_NUM \
                                                    + CLI_TASK_MAX_PROVISION_SESSION_NUM    \
                                                    + CLI_TASK_MAX_BACKDOOR_SESSION_NUM     \
                                                    + CLI_TASK_MAX_MODULE_PROVISION_SESSION_NUM)
#define CLI_TASK_MIN_SESSION_ID                     0
#define CLI_TASK_MAX_SESSION_ID                     (CLI_TASK_MAX_SESSION_NUM - 1)
...
#define CLI_TASK_PARTIAL_PROV_SESSION_ID            (CLI_TASK_MAX_TELNET_SESSION_ID + 1)
#define CLI_TASK_PROVISION_SESSION_ID               (CLI_TASK_PARTIAL_PROV_SESSION_ID + 1)
...
#define CLI_TASK_VTY_STR                "Vty"
#define CLI_TASK_TELNET_STR             "Telnet"
...
/*------------------------------------------------------------------------
 * ROUTINE NAME - CLI_TASK_InitConsoleSessionAuthState
 *------------------------------------------------------------------------
 * PURPOSE : initial authentication state in console session
 * INPUT   : none
 * OUTPUT  : none
 * RETURN  : none
 * NOTE    :
