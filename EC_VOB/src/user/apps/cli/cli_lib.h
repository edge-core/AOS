...
#define PRIVILEGE_CFG_INTERFACE_MLD_PROFILE_PROMPT      "(config-mld-profile)#"
#if (SYS_CPNT_IP_FOR_ETHERNET0 == TRUE)
#define PRIVILEGE_CFG_INTERFACE_ETH0_MODE_PROMPT        "(config-if)#"
#endif
#define PRIVILEGE_CFG_CONTROL_PLANE_MODE_PROMPT         "(config-cp)#"
...
#define PRIVILEGE_CFG_LINE_CONSOLE_MODE_PROMPT          "(config-line-console)#"
#define PRIVILEGE_CFG_LINE_VTY_MODE_PROMPT              "(config-line-vty)#"
...
#define PRIVILEGE_CFG_HASH_SELECTION_MAC_PROMPT          "(config-mac-hash-sel)#"
#define PRIVILEGE_CFG_HASH_SELECTION_IPV4_PROMPT         "(config-ipv4-hash-sel)#"
#define PRIVILEGE_CFG_HASH_SELECTION_IPV6_PROMPT         "(config-ipv6-hash-sel)#"
#endif
...
#define PRIVILEGE_CFG_INTERFACE_MLD_PROFILE_HELP_MSG    "Privileged interface MLD profile configuration mode"
#define PRIVILEGE_CFG_INTERFACE_ETH0_MODE_HELP_MSG      "Privileged interface port0 configuration mode"
#define PRIVILEGE_CFG_CONTROL_PLANE_MODE_HELP_MSG       "Privileged control plane configuration mode"
...
#define PRIVILEGE_CFG_LINE_CONSOLE_MODE_HELP_MSG        "Line console configuration mode"
#define PRIVILEGE_CFG_LINE_VTY_MODE_HELP_MSG            "Line VTY configuration mode"
...
#define PRIVILEGE_CFG_ELPS_MODE_HELP_MSG                "ELPS mode"
#define PRIVILEGE_CFG_HASH_SELECTION_MAC_HELP_MSG       "Hash-selection MAC mode"
#define PRIVILEGE_CFG_HASH_SELECTION_IPV4_HELP_MSG      "Hash-selection IPv4 mode"
#define PRIVILEGE_CFG_HASH_SELECTION_IPV6_HELP_MSG      "Hash-selection IPv6 mode"
...
UI16_T  CLI_LIB_IsSameWithLastHistBuf(char *s, CLI_TASK_WorkingArea_T *ctrl_P);
...
BOOL_T  CLI_LIB_EAtoStr(UI8_T *mac, char *String);   //cjchu 2001/8/2
...
struct GetMaxCommandPrivilegeParam
{
    UI32_T   max_privilege;
    UI32_T   end_index;
};
 ...
 */
UI32_T
CLI_LIB_GetMaxCommandPrivilege(
    const UI32_T cmd_index,
