...
}	/*	end of TRK_INIT_InitiateSystemResources	*/
...
{
    TRK_MGR_Create_InterCSC_Relation();
}
...
{
    TRK_MGR_HandleHotInsertion(starting_port_ifindex, number_of_port, use_default);
}
...
{
    TRK_MGR_HandleHotRemoval(starting_port_ifindex, number_of_port);
}
