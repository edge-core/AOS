...
/*------------------------------------------------------------------------------
 * ROUTINE NAME : SYSRSC_MGR_AttachSystemResourcesWithoutCscRsc
 *------------------------------------------------------------------------------
 * PURPOSE:
 *    This api will invoke attach resources provided by SYSRSC
 *
 * INPUT:
 *    None.
 *
 ...
 *------------------------------------------------------------------------------
 */
BOOL_T SYSRSC_MGR_AttachSystemResourcesWithoutCscRsc(void)
{
    UI32_T shmid;
...
{
    if (!SYSRSC_MGR_AttachSystemResourcesWithoutCscRsc())
    {
        return FALSE;
    }
...
static void SYSRSC_MGR_AttachAllCSCSystemResources(void)
{
    ...
    SYSRSC_DBG("%s: Invoke RULE_OM_EXP_AttachSystemResources()\r\n", __FUNCTION__);
...
#if (SYS_CPNT_PFC == TRUE)
    SYSRSC_DBG("%s: Invoke PFC_OM_AttachSystemResources()\r\n", __FUNCTION__);
    PFC_OM_AttachSystemResources();
#endif
...
#if (SYS_CPNT_SW_WATCHDOG_TIMER == TRUE)
    SW_WATCHDOG_MGR_AttachSystemResources();
#endif

#if (SYS_CPNT_DOS == TRUE)
    SYSRSC_DBG("%s: Invoke DOS_OM_AttachSystemResources()\r\n", __FUNCTION__);
    DOS_OM_AttachSystemResources();
#endif

#if (SYS_CPNT_SWCTRL == TRUE)
    SYSRSC_DBG("%s: Invoke SWCTRL_OM_AttachSystemResources()\r\n", __FUNCTION__);
    SWCTRL_OM_AttachSystemResources();
#endif
...
#if (SYS_CPNT_DEBUG == TRUE)
    SYSRSC_DBG("%s: Invoke DEBUG_MGR_AttachSystemResources()\r\n", __FUNCTION__);
    DEBUG_MGR_AttachSystemResources();
#endif

#if (SYS_CPNT_SYNCE == TRUE)
    SYSRSC_DBG("%s: Invoke SYNCEDRV_OM_AttachSystemResources()\r\n", __FUNCTION__);
    SYNCEDRV_OM_AttachSystemResources();
#endif

#if (SYS_CPNT_CN == TRUE)
    SYSRSC_DBG("%s: Invoke CN_OM_AttachSystemResources()\r\n", __FUNCTION__);
    CN_OM_AttachSystemResources();
#endif

#if (SYS_CPNT_SFLOW == TRUE)
    SYSRSC_DBG("%s: Invoke SFLOW_OM_AttachSystemResources()\r\n", __FUNCTION__);
    SFLOW_OM_AttachSystemResources();
#endif

#if (SYS_CPNT_APP_FILTER == TRUE)
    SYSRSC_DBG("%s: Invoke AF_OM_AttachSystemResources()\r\n", __FUNCTION__);
    AF_OM_AttachSystemResources();
#endif /* #if (SYS_CPNT_APP_FILTER == TRUE) */

#if (SYS_CPNT_EH == TRUE)
    SYSRSC_DBG("%s: Invoke EH_MGR_AttachSystemResources()\r\n", __FUNCTION__);
    EH_MGR_AttachSystemResources();
    SYSRSC_DBG("%s: Invoke EH_OM_AttachSystemResources()\r\n", __FUNCTION__);
    EH_OM_AttachSystemResources();
#endif

#if(SYS_CPNT_CLI == TRUE)
    SYSRSC_DBG("%s: Invoke CLI_OM_EXP_AttachSystemResources()\r\n", __FUNCTION__);
    CLI_OM_EXP_AttachSystemResources();
#endif  /* SYS_CPNT_CLI */
#if (SYS_CPNT_VXLAN == TRUE)
    SYSRSC_DBG("%s: Invoke  VXLAN_OM_AttachSystemResources()\r\n", __FUNCTION__);
    VXLAN_OM_AttachSystemResources();
#endif

#if (SYS_CPNT_UCMGMT == TRUE)
    SYSRSC_DBG("%s: Invoke  UC_MGR_AttachSystemResources()\r\n", __FUNCTION__);
    UC_MGR_AttachSystemResources();
#endif

#if (SYS_CPNT_WEBAUTH == TRUE)
    SYSRSC_DBG("%s: Invoke  WEBAUTH_OM_AttachSystemResources()\r\n", __FUNCTION__);
    WEBAUTH_OM_AttachSystemResources();
#endif
}
