...
typedef enum
{
    ...
    SYSRSC_MGR_DEBUG_OM_SHMEM_SEGID,
    SYSRSC_MGR_SW_WATCHDOG_SHMEM_SEGID,
    SYSRSC_MGR_DOS_SHMEM_SEGID,
    SYSRSC_MGR_LBD_OM_SHMEM_SEGID,
    SYSRSC_MGR_SWCTRL_SHMEM_SEGID,
    SYSRSC_MGR_UDLD_OM_SHMEM_SEGID,
    SYSRSC_MGR_SYNCEDRV_SHMEM_SEGID,
    SYSRSC_MGR_ELPS_OM_SHMEM_SEGID,
    SYSRSC_MGR_PFC_OM_SHMEM_SEGID,
    SYSRSC_MGR_CN_SHMEM_SEGID,
    SYSRSC_MGR_SFLOW_OM_SHMEM_SEGID,
    SYSRSC_MGR_APP_FILTER_OM_SHMEM_SEGID,
    SYSRSC_MGR_CLI_OM_SHMEM_SEGID,
    SYSRSC_MGR_EH_OM_SHMEM_SEGID,
    SYSRSC_MGR_VXLAN_SHMEM_SEGID,
    SYSRSC_MGR_UC_SHMEM_SEGID,
    SYSRSC_MGR_WEBAUTH_OM_SHMEM_SEGID,
    SYSRSC_MGR_OVSVTEP_OM_SHMEM_SEGID,
    SYSRSC_MGR_MAX_SEGID /* for validation check */
} SYSRSC_MGR_SEGID_T;

/* MACRO FUNCTION DECLARATIONS
 */
#define SYSRSC_MGR_SHMEM_HEADER_SIZE(num_of_seg) ((uintptr_t)(((SYSRSC_MGR_ShMemHeader_T*)0)->seg_descs) + sizeof(SYSRSC_MGR_ShMemDesc_T)*(num_of_seg))
 ...
 *------------------------------------------------------------------------------
 * PURPOSE:
 *    This api will only attach resources provided by SYSRSC.
 *
 * INPUT:
 *    None.
 *
