/* static char SccsId[] = "+-<>?!SNTP_INIT.H   22.1  22/04/02  15:00:00";
 * ------------------------------------------------------------------------
 *  FILE NAME  -  _SNTP_INIT.H
 * ------------------------------------------------------------------------
 *  ABSTRACT:
 *
 ...
 */
 ...
 /*--------------------------------------------------------------------------
 * ROUTINE NAME - SNTP_INIT_Initiate_System_Resources
 *---------------------------------------------------------------------------
...
/*--------------------------------------------------------------------------
 * ROUTINE NAME - SNTP_INIT_Create_Tasks()
 *---------------------------------------------------------------------------
