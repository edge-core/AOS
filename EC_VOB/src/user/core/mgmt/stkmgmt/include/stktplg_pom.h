/* MODULE NAME:  stktplg_pom.h
 * PURPOSE:
 *  Define stktplg POM APIs.
 *
 * NOTES:
 *
 * HISTORY
 ...
 */
#ifndef STKTPLG_POM_H
#define STKTPLG_POM_H
...
/* -------------------------------------------------------------------------
 * ROUTINE NAME - STKTPLG_POM_GetNextUnitDown
 * -------------------------------------------------------------------------
 * FUNCTION: Get Next Unit ID.
 * INPUT   : unit_id       -- Which Unit
 ...
 * NOTE    : 
 * -------------------------------------------------------------------------*/
BOOL_T STKTPLG_POM_GetNextUnitDown(UI32_T *unit_id);
