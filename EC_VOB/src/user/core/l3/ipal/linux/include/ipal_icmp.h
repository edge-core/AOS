...
#ifndef __IPAL_ICMP_H
#define __IPAL_ICMP_H
 ...
 * PURPOSE:
 *      Set the interface retransmit time interval of Neighbor Solicitation packet
 ...
 * PURPOSE:
 *      Set the reachable time interval of Neighbor Solicitation packet
...
/* FUNCTION NAME : IPAL_ICMP_SetIpv6DadTransmits
 * PURPOSE:
 *      Set the transmit times of DAD
 *      (/proc/sys/net/ipv6/conf/eth1/dad_transmits)
 * INPUT:
 *      ifindex    -- L3 interface index
 *      trans_time -- number of DAD transmit time
 * OUTPUT:
 *      None
 * RETURN:
 *      IPAL_RESULT_OK   --  success
 ...
 * NOTES:
 */
UI32_T IPAL_ICMP_SetIpv6DadTransmits(UI32_T ifindex, UI32_T trans_time);
