...
#define RULE_TYPE_UNDEF_ICMP_TYPE                       MAX_diffServIpAceIcmpType
#define RULE_TYPE_UNDEF_TIME_RANGE                      0xFFFF
...
#define RULE_TYPE_MAX_OF_IP_ICMP_TYPE                   (MAX_diffServIpAceIcmpType - 1)
...
#define RULE_TYPE_TIME_RANGE_MIN_YEAR                   2009
#define RULE_TYPE_TIME_RANGE_MAX_YEAR                   2037
...
#define RULE_TYPE_TCAM_CAP_MAX_STR_LEN                   16
...
_(RULE_TYPE_TCAM_CAP_IPV6_STD_ACL,         "A6S",      "IPv6 Std ACL")              \
_(RULE_TYPE_TCAM_CAP_IPV6_EXT_ACL,         "A6E",      "IPv6 Ext ACL")              \
_(RULE_TYPE_TCAM_CAP_MAC_DS,               "DM",       "MAC DiffServ")              \
_(RULE_TYPE_TCAM_CAP_IPV4_DS,              "D4",       "IPv4 DiffServ")             \
_(RULE_TYPE_TCAM_CAP_IPV6_STD_DS,          "D6S",      "IPv6 Std DiffServ")         \
_(RULE_TYPE_TCAM_CAP_IPV6_EXT_DS,          "D6E",      "IPv6 Ext DiffServ")         \
_(RULE_TYPE_TCAM_CAP_EGRESS_MAC_ACL,       "AEM",      "Egress MAC ACL")            \
_(RULE_TYPE_TCAM_CAP_EGRESS_IPV4_ACL,      "AE4",      "Egress IPv4 ACL")           \
_(RULE_TYPE_TCAM_CAP_EGRESS_IPV6_STD_ACL,  "AE6S",     "Egress IPv6 Std ACL")       \
_(RULE_TYPE_TCAM_CAP_EGRESS_IPV6_EXT_ACL,  "AE6E",     "Egress IPv6 Ext ACL")       \
_(RULE_TYPE_TCAM_CAP_EGRESS_MAC_DS,        "DEM",      "Egress MAC DiffServ")       \
_(RULE_TYPE_TCAM_CAP_EGRESS_IPV4_DS,       "DE4",      "Egress IPv4 DiffServ")      \
_(RULE_TYPE_TCAM_CAP_EGRESS_IPV6_STD_DS,   "DE6S",     "Egress IPv6 Std DiffServ")  \
_(RULE_TYPE_TCAM_CAP_EGRESS_IPV6_EXT_DS,   "DE6E",     "Egress IPv6 Ext DiffServ")  \
...
_(RULE_TYPE_TCAM_CAP_PBR,                  "PBR",      "Policy Based Route")        \
                                                                                    \
/* Reserved and ALL should be at the last */                                        \
_(RULE_TYPE_TCAM_CAP_RESERVED,             "Reserved", "Reserved")                  \
_(RULE_TYPE_TCAM_CAP_RESERVED_INGRESS,     "Reserved(IFP)", "Reserved(IFP)")        \
_(RULE_TYPE_TCAM_CAP_RESERVED_EGRESS,      "Reserved(EFP)", "Reserved(EFP)")        \
_(RULE_TYPE_TCAM_CAP_RESERVED_VLAN,        "Reserved(VFP)", "Reserved(VFP)")        \
...
typedef enum
{
    RULE_TYPE_TIME_RANGE_REF_COUNT_PLUS,
    RULE_TYPE_TIME_RANGE_REF_COUNT_MINUS,
}RULE_TYPE_TIME_RANGE_REF_COUNT_T;

typedef enum
{
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_SUNDAY    = 0,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_MONDAY    = 1,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_TUESDAY   = 2,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_WEDNESDAY = 3,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_THURSDAY  = 4,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_FRIDAY    = 5,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_SATURDAY  = 6,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_DAILY     = 7,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_WEEKDAYS  = 8,
    RULE_TYPE_TIME_RANGE_TYPE_OF_WK_WEEKEND   = 9,
}RULE_TYPE_TIME_RANGE_TYPE_OF_WK_T;
...
typedef enum
{
    ...
    RULE_TYPE_Pkt2CpuRule_OSPF6_DIP5,
    RULE_TYPE_Pkt2CpuRule_OSPF6_DIP6,
...
/* FIXME: MUST BE DELETED. */                                                                                              \
    ...
    _(RULE_TYPE_FUNCTION_TYPE_OSPF6,           "RT_FUNCTION_TYPE_OSPF6",           RULE_TYPE_TCAM_CAP_IPV6_EXT_ACL)        \
    _(RULE_TYPE_FUNCTION_TYPE_IPV6_ALL_NODES,  "RT_FUNCTION_TYPE_IPV6_ALL_NODES",  RULE_TYPE_TCAM_CAP_IPV6_EXT_ACL)        \
    _(RULE_TYPE_FUNCTION_TYPE_IPV6_ALL_ROUTERS,"RT_FUNCTION_TYPE_IPV6_ALL_ROUTERS",RULE_TYPE_TCAM_CAP_IPV6_EXT_ACL)        \
    ...
    _(RULE_TYPE_FUNCTION_TYPE_LINK_LOCAL_ADDR, "RT_FUNCTION_TYPE_LINK_LOCAL_ADDR", RULE_TYPE_TCAM_CAP_LINK_LOCAL)          \
    ...
    _(RULE_TYPE_PACKET_TO_CPU_MLD,             "RT_PACKET_TO_CPU_MLD",             RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
                                                                                                                           \
    _(RULE_TYPE_FUNCTION_TYPE_ALL_ARP_REQUEST, "RT_FUNCTION_TYPE_ALL_ARP_REQUEST", RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ARP_REQUEST,     "RT_FUNCTION_TYPE_ARP_REQUEST",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ALL_ARP_REPLY,   "RT_FUNCTION_TYPE_ALL_ARP_REPLY",   RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ARP_REPLY,       "RT_FUNCTION_TYPE_ARP_REPLY",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_RIP,             "RT_FUNCTION_TYPE_RIP",             RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_RA_GUARD_DENY_RA,"RT_FUNCTION_TYPE_RA_GUARD_DENY_RA",RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_RA_GUARD_DENY_RR,"RT_FUNCTION_TYPE_RA_GUARD_DENY_RR",RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_UNICAST_EAPOL,   "RT_FUNCTION_TYPE_UNICAST_EAPOL",   RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_EAPOL_PASS_THROUGH,     "RT_FUNCTION_TYPE_EAPOL_PASS_THROUGH",      RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_QINQ_L2PT_DA_REMARK,    "RT_FUNCTION_TYPE_QINQ_L2PT_DA_REMARK",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_QINQ_L2PT_CUSTOM_PDU,   "RT_FUNCTION_TYPE_QINQ_L2PT_CUSTOM_PDU",    RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_DENY_MULTICAST_DATA,    "RT_FUNCTION_TYPE_DENY_MULTICAST_DATA",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_IP6_DENY_MULTICAST_DATA,"RT_FUNCTION_TYPE_IP6_DENY_MULTICAST_DATA", RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_WEBAUTH_TRAP_HTTP,      "RT_FUNCTION_TYPE_WEBAUTH_TRAP_HTTP",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_WEBAUTH_PERMIT_DHCPC,   "RT_FUNCTION_TYPE_WEBAUTH_PERMIT_DHCPC",    RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_WEBAUTH_PERMIT_DNS,     "RT_FUNCTION_TYPE_WEBAUTH_PERMIT_DNS",      RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_WEBAUTH_DENY_ANY_IP,    "RT_FUNCTION_TYPE_WEBAUTH_DENY_ANY_IP",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_WEBAUTH_PERMIT_IP,      "RT_FUNCTION_TYPE_WEBAUTH_PERMIT_IP",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_IPSG_PERMIT_SIP,        "RT_FUNCTION_TYPE_IPSG_PERMIT_IP",          RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_IPSG_DENY_ANY_IP,       "RT_FUNCTION_TYPE_IPSG_DENY_ANY_IP",        RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_IPSG6_PERMIT_SIP,       "RT_FUNCTION_TYPE_IPSG6_PERMIT_IP",         RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_IPSG6_DENY_ANY_IP,      "RT_FUNCTION_TYPE_IPSG6_DENY_ANY_IP",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_OAM_LOOPBACK,    "RT_FUNCTION_TYPE_OAM_LOOPBACK",    RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_AF_DENY_CDP,     "RT_FUNCTION_TYPE_AF_DENY_CDP",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_AF_DENY_PVST,    "RT_FUNCTION_TYPE_AF_DENY_PVST",    RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_CDP,             "RT_FUNCTION_TYPE_CDP",             RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_PVST,            "RT_FUNCTION_TYPE_PVST",            RULE_TYPE_TCAM_CAP_CPU_INTERFACE) \
    _(RULE_TYPE_FUNCTION_TYPE_PTP_EVENT_ETH,       "RT_FUNCTION_TYPE_PTP_EVENT_ETH",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
    _(RULE_TYPE_FUNCTION_TYPE_PTP_EVENT_UDP,       "RT_FUNCTION_TYPE_PTP_EVENT_UDP",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
    _(RULE_TYPE_FUNCTION_TYPE_PTP_GENERAL_UDP,     "RT_FUNCTION_TYPE_PTP_GENERAL_UDP",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
    _(RULE_TYPE_FUNCTION_TYPE_UNKNOWN_IPV6_MCAST,  "RT_FUNCTION_TYPE_UNKNOWN_IPV6_MCAST",  RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
    _(RULE_TYPE_FUNCTION_TYPE_MLD_QUERY,        "RT_FUNCTION_TYPE_MLD_QUERY",      RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_MLD_REPORT,       "RT_FUNCTION_TYPE_MLD_REPORT",     RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_MLD_DONE,         "RT_FUNCTION_TYPE_MLD_DONE",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_MLDV2_REPORTS,    "RT_FUNCTION_TYPE_MLDV2_REPORTS",  RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_DHCP_CLIENT,      "RT_FUNCTION_TYPE_DHCP_CLIENT",    RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_DHCP_SERVER,      "RT_FUNCTION_TYPE_DHCP_SERVER",    RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_DHCP6_CLIENT,     "RT_FUNCTION_TYPE_DHCP6_CLIENT",   RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_DHCP6_SERVER,     "RT_FUNCTION_TYPE_DHCP6_SERVER",   RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ORG_SPECIFIC,     "RT_FUNCTION_TYPE_ORG_SPECIFIC",   RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ORG_SPECIFIC1,    "RT_FUNCTION_TYPE_ORG_SPECIFIC1",  RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ORG_SPECIFIC2,    "RT_FUNCTION_TYPE_ORG_SPECIFIC2",  RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ORG_SPECIFIC3,    "RT_FUNCTION_TYPE_ORG_SPECIFIC3",  RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_IGMP,             "RT_FUNCTION_TYPE_IGMP",           RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_OSPF,            "RT_FUNCTION_TYPE_OSPF",            RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_PIM,             "RT_FUNCTION_TYPE_PIM",             RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_VRRP,            "RT_FUNCTION_TYPE_VRRP",            RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_UNKNOWN_IP_MCAST, "RT_FUNCTION_TYPE_UNKNOWN_IP_MCAST", RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
    _(RULE_TYPE_FUNCTION_TYPE_IP_BCAST,        "RT_FUNCTION_TYPE_IP_BCAST",        RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_L2_SLF,          "RT_FUNCTION_TYPE_L2_SLF",          RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ALL_HOST,        "RT_FUNCTION_TYPE_ALL_HOST",        RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_ALL_ROUTER,      "RT_FUNCTION_TYPE_ALL_ROUTER",      RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_IP_OPTION,       "RT_FUNCTION_TYPE_IP_OPTION",       RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_BPDU,            "RT_FUNCTION_TYPE_BPDU",            RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_L2CP,            "RT_FUNCTION_TYPE_L2CP",            RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_CFM,             "RT_FUNCTION_TYPE_CFM",             RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_RAPS,            "RT_FUNCTION_TYPE_RAPS",            RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_OAM,             "RT_FUNCTION_TYPE_OAM",             RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_OAM_LB_TO_RECV_PORT, "RT_FUNCTION_TYPE_OAM_LB_TO_RECV_PORT", RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
    _(RULE_TYPE_FUNCTION_TYPE_PPPOE,           "RT_FUNCTION_TYPE_PPPOE",           RULE_TYPE_TCAM_CAP_CPU_INTERFACE)       \
    _(RULE_TYPE_FUNCTION_TYPE_CANCEL_RESERVED_MCAST, "RT_FUNCTION_TYPE_CANCEL_RESERVED_MCAST", RULE_TYPE_TCAM_CAP_CPU_INTERFACE)\
                                                                                                                           \
    ...
    _(RULE_TYPE_FUNCTION_TYPE_PBR,             "RT_PACKET_PBR",                    RULE_TYPE_TCAM_CAP_PBR)                 \
    _(RULE_TYPE_EGRESS_ACL,                    "RT_EGRESS_ACL",                    RULE_TYPE_TCAM_CAP_EGRESS_MAC_ACL)      \
...
typedef struct
{
    ...
    union {
        UI32_T                      dest_ifindex;  /*for acl entry*/

        struct
        {
            UI32_T                  dst_phy_port;
            UI32_T                  dst_module_id;
        };                                         /* for acl instance*/
    };
...
typedef UI64_T                  RULE_TYPE_INSTANCE_ID_T;
...
typedef struct
{
    ...
    RULE_TYPE_SHM_POINTER_T     sharing_next;
    RULE_TYPE_SHM_POINTER_T     sharing_prev;
    ...
    union
    {
        ...
        //UI64_T                  id;
        RULE_TYPE_INSTANCE_ID_T id;

        //
        // l4 (backward compatibile)
        //
        RULE_TYPE_INSTANCE_ID_T policy_map_id;
        RULE_TYPE_INSTANCE_ID_T class_map_id;
        RULE_TYPE_INSTANCE_ID_T acl_id;
    };
    ...
    RULE_TYPE_ACL_MIRROR_T          mirror;   /*for ingress*/
#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
    RULE_TYPE_ACL_MIRROR_T          mirror_egress;
#endif
...
typedef struct
{
    ...
    {
        RULE_TYPE_INSTANCE_ID_T id;
        RULE_TYPE_INSTANCE_ID_T ace_id;
    };
...
#if (SYS_CPNT_ACL_MIRROR == TRUE)
    RULE_TYPE_ACL_MIRROR_T          mirror;   /*mirror ingress*/
#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
    RULE_TYPE_ACL_MIRROR_T          mirror_egress;
#endif
#endif /* #if (SYS_CPNT_ACL_MIRROR == TRUE) */
...
typedef struct
{
    ...
    UI32_T  second;
    UI32_T  time_by_sec;
} RULE_TYPE_TIME_ACL_CONVERT_TIME_T;

typedef struct
{
     UI32_T    time_by_sec;
     UI16_T    year;            /* 1980-2079 */
     UI8_T     month;           /* 01-12 */
     UI8_T     day;             /* 01-31 */
     UI8_T     hour;            /* 00-23 */
     UI8_T     minute;          /* 00-59 */
} RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T;

typedef struct
{
     UI8_T     start_type_of_wk;/* RULE_TYPE_TIME_RANGE_TYPE_OF_WK_T */
     UI8_T     start_hour;      /* 00-23 */
     UI8_T     start_minute;    /* 00-59 */
     UI8_T     end_type_of_wk;  /* RULE_TYPE_TIME_RANGE_TYPE_OF_WK_T */
     UI8_T     end_hour;        /* 00-23 */
     UI8_T     end_minute;      /* 00-59 */
} RULE_TYPE_TIME_ACL_PERIODIC_TIME_T;

typedef struct
{
    UI32_T      ref_counter;
    BOOL_T      valid;
    char        name[SYS_ADPT_MAX_LENGTH_OF_TIME_ACL_TABLE_NAME + 1];
    RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T       start_time;
    RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T       end_time;
    RULE_TYPE_TIME_ACL_PERIODIC_TIME_T            periodic_daily_time[SYS_ADPT_MAX_NBRS_OF_TIME_ACL_PERIODIC];
    BOOL_T      check_start_absolute;
    BOOL_T      check_end_absolute;
    BOOL_T      check_periodic[SYS_ADPT_MAX_NBRS_OF_TIME_ACL_PERIODIC];
    BOOL_T      active;
} RULE_TYPE_TIME_ACL_TIME_RANGE_T;
...
typedef enum
{
    ...
    RULE_TYPE_PBR_REDIRECT_ACTION_ROUTE
...
typedef struct
{
    ...
    //
    // FIXME: this is patch code,
    //   The redirect parameter is different between bcm and mvl on rule_ctrl, it is incorrect.
    //   It should use the same parameter on rule_ctrl, and assign to related parameter on gateway for setting chip. 
    //
