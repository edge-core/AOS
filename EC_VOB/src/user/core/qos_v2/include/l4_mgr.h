...
enum
{
    ...
    L4_MGR_IPCCMD_ACL_CREATETIMERANGE,
    L4_MGR_IPCCMD_ACL_DELETETIMERANGE,
    L4_MGR_IPCCMD_ACL_SETTIMERANGEABSOLUTE,
    L4_MGR_IPCCMD_ACL_DESTORYTIMERANGEABSOLUTE,
    L4_MGR_IPCCMD_ACL_SETTIMERANGEPERIODIC,
    L4_MGR_IPCCMD_ACL_DESTORYTIMERANGEPERIODIC,
    L4_MGR_IPCCMD_ACL_GETNEXTTIMERANGE,
    L4_MGR_IPCCMD_ACL_GETTIMERANGEIDBYNAME,
    L4_MGR_IPCCMD_ACL_GETTIMERANGENAMEBYID,
    L4_MGR_IPCCMD_ACL_GETNEXTRUNNINGTIMERANGE,
    ...
    L4_MGR_IPCCMD_ACL_SET_ACL_MIRROR_ENTRY_FOR_MIB,
    ...
    L4_MGR_IPCCMD_QOS_SETPORTEGRESSHYBRIDQUEUEMODE,
...
typedef struct
{
    ...
    union
    {
        ...
        {
            UI16_T index;
            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T start_absolute_time_date;
            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T end_absolute_time_date;
            RULE_TYPE_TIME_ACL_PERIODIC_TIME_T      periodic_time;
            BOOL_T start_is_null;
            BOOL_T end_is_null;
        ...
        {
            UI16_T index;
            RULE_TYPE_TIME_ACL_TIME_RANGE_T entry;
            char   name[SYS_ADPT_MAX_LENGTH_OF_TIME_ACL_TABLE_NAME+1];
        }acl_time_range_entry;
#endif /*#if (SYS_CPNT_TIME_BASED_ACL == TRUE)*/
 ...
 *           start_absolute_time_date - start absolute time and date
 *           end_absolute_time_date   - end absolute time and date
 * OUTPUT:   NONE.
 * RETURN:   Error code.
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_DestoryTimeRangeAbsolute(char *time_range_name);
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_SetTimeRangePeriodic(char *time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time);
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_DestoryTimeRangePeriodic(char *time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time);
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_GetTimeRangeIdByName(char *time_range_name, UI16_T *p_time_range_index);
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_GetTimeRangeNameByID(UI16_T time_range_index, char *time_range_name);
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_GetNextAclByPortAndAclType
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
UI32_T L4_MGR_ACL_GetNextAclByPortAndAclType(UI32_T uport_ifindex, UI32_T *acl_index, RULE_TYPE_UI_AclEntry_T *acl_entry, UI16_T *p_time_range_index);
 ...
 *------------------------------------------------------------------------------
 */
UI32_T L4_MGR_ACL_GetNextUIAclByPortAndBindingType(UI32_T precedence, UI32_T *uport_ifindex, RULE_TYPE_UI_AclEntry_T *acl_entry, UI16_T *p_time_range_index);
