...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_GetNextAclByPortAndAclType
 *------------------------------------------------------------------------------
 * PURPOSE:  Get next binding ACL by port and acl_type
 * INPUT:    uport_ifindex, acl_index, acl_entry->acl_type
 * OUTPUT:   acl_index, acl_entry, p_time_range_index.
 * RETURN:   Error code.
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
UI32_T L4_PMGR_ACL_GetNextAclByPortAndAclType(UI32_T uport_ifindex, UI32_T *acl_index, RULE_TYPE_UI_AclEntry_T *acl_entry, UI16_T *p_time_range_index);
