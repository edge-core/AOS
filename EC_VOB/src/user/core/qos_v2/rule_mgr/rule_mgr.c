...
{
#if (SYS_CPNT_TIME_BASED_ACL == TRUE) || (SYS_CPNT_QOS_V2_SOFTWARE_BUNDLE_RATE_CONTROL == TRUE)
    RULE_CTRL_ProcessTimerEvent();
#endif /* SYS_CPNT_TIME_BASED_ACL || SYS_CPNT_QOS_V2_SOFTWARE_BUNDLE_RATE_CONTROL */
    return TRUE;
}
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_CreateTimeRange
 *------------------------------------------------------------------------------
 * PURPOSE:  Create a time range.
 * INPUT:    time_range_name    - time range name
 * OUTPUT:   p_time_range_index - time range index
 * RETURN:   Error code (OK / FAIL)
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_CreateTimeRange(const char *time_range_name, UI16_T *p_time_range_index)
{
    return RULE_OM_CreateTimeRangeEntry(time_range_name, p_time_range_index);
}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_DeleteTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_DeleteTimeRange(const char *time_range_name)
{
    UI16_T time_range_index;

    if (RULE_TYPE_OK != RULE_OM_GetTimeRangeIdByName(time_range_name, &time_range_index))
    {
        return RULE_TYPE_FAIL;
    }

    return RULE_OM_DeleteTimeRangeEntry(time_range_index);
}


/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_SetTimeRangeAbsolute
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_SetTimeRangeAbsolute(char *time_range_name,
                        ...
                        RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T *p_end_absolute_time_date)
{
    ...
    if ( (NULL != p_start_absolute_time_date) &&
         (NULL != p_end_absolute_time_date) )
    {
        if (p_start_absolute_time_date->time_by_sec > p_end_absolute_time_date->time_by_sec)
        {
            return RULE_TYPE_FAIL;
        }
    }

    return RULE_OM_SetTimeRangeAbsolute(time_range_index, p_start_absolute_time_date,
                                    p_end_absolute_time_date);
}


/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_DestoryTimeRangeAbsolute
 *------------------------------------------------------------------------------
 * PURPOSE:  Destory a time range absolute time and date.
 * INPUT:    time_range_name
 * OUTPUT:   NONE.
 * RETURN:   Error code.
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_DestoryTimeRangeAbsolute(char *time_range_name)
{
    UI16_T time_range_index;
    ...
    return RULE_OM_DestoryTimeRangeAbsolute(time_range_index);
}


/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_SetTimeRangePeriodic
 *------------------------------------------------------------------------------
...
RULE_MGR_SetTimeRangePeriodic(
    const char *time_range_name,
    RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time)
{
    UI16_T time_range_index;

    switch (p_periodic_time->start_type_of_wk)
    {
        ...
        case RULE_TYPE_TIME_RANGE_TYPE_OF_WK_WEEKEND:
            /* check type of day */
            if (p_periodic_time->start_type_of_wk != p_periodic_time->end_type_of_wk)
            {
                /* invalid settings*/
                return RULE_TYPE_FAIL;
            }
            ...
            if (p_periodic_time->start_hour > p_periodic_time->end_hour)
            {
                /* invalid settings*/
                return RULE_TYPE_FAIL;
            }
            else if (p_periodic_time->start_hour == p_periodic_time->end_hour)
            {
                if (p_periodic_time->start_minute >= p_periodic_time->end_minute)
                {
                    /* invalid settings*/
                    return RULE_TYPE_FAIL;
                }
        ...
        case RULE_TYPE_TIME_RANGE_TYPE_OF_WK_SATURDAY:
            ...
            if (p_periodic_time->end_type_of_wk == RULE_TYPE_TIME_RANGE_TYPE_OF_WK_DAILY ||
                p_periodic_time->end_type_of_wk == RULE_TYPE_TIME_RANGE_TYPE_OF_WK_WEEKDAYS ||
                p_periodic_time->end_type_of_wk == RULE_TYPE_TIME_RANGE_TYPE_OF_WK_WEEKEND)
            {
                return RULE_TYPE_FAIL;
            }
    ...
    return RULE_OM_SetTimeRangePeriodic(time_range_index, p_periodic_time);

}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_DestoryTimeRangePeriodic
 *------------------------------------------------------------------------------
 * PURPOSE:  Destory an time range periodic time and day.
 * INPUT:    time_range_name   - time range name
 *           p_periodic_time   - periodic time
 * OUTPUT:   NONE.
 * RETURN:   Error code.
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_DestoryTimeRangePeriodic(char *time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time)
{
    UI16_T time_range_index;
    ...
    return RULE_OM_DestoryTimeRangePeriodic(time_range_index, p_periodic_time);

}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_GetTimeRangeIdByName
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_GetTimeRangeIdByName(const char *time_range_name, UI16_T *p_time_range_index)
{
    return RULE_OM_GetTimeRangeIdByName(time_range_name, p_time_range_index);
}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_GetTimeRangeNameByID
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_GetTimeRangeNameByID(UI16_T time_range_index, char *time_range_name)
{
    return RULE_OM_GetTimeRangeNameByID(time_range_index, time_range_name);
}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_GetNextTimeRange
 *------------------------------------------------------------------------------
 * PURPOSE:  Get next time range entry by time range index
 * INPUT:    p_time_range_index - time range index
 *           p_time_range_entry - time range entry
 * OUTPUT:   p_time_range_index - time range index
 *           p_time_range_entry - time range entry
 * RETURN:   Error code.
 * NOTE:     Let *p_time_range_index = RULE_TYPE_UNDEF_TIME_RANGE to get first enty
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T RULE_MGR_GetNextTimeRange(UI16_T *p_time_range_index, RULE_TYPE_TIME_ACL_TIME_RANGE_T *p_time_range_entry)
{

    return RULE_OM_GetNextTimeRange(p_time_range_index, p_time_range_entry);
}
    ...
    UI32_T policy_map_index)
{
    ...
    LOG("ifindex(%u), direction(%s), policy_map_index(%u)",
        ifindex,
    ...
    {
        LOG("<Error> Invalid parameter. ifindex(%u)", ifindex);
...
UI32_T RULE_MGR_SetElementActionFromPolicyMap(UI32_T policy_map_index, UI32_T class_map_index, RULE_TYPE_UI_Action_T *action_entry)
{
    ...
    action_flag = (RULE_TYPE_OK == RULE_OM_GetActionEntryByIndex(policy_element.meter_index, &org_action));
...
UI32_T RULE_MGR_SetActionEntry(UI32_T action_index, const RULE_TYPE_Action_T *action_entry)
{
    ...
    if (RULE_TYPE_OK != RULE_OM_GetActionEntryByIndex(action_index, &org_action))
        return RULE_TYPE_FAIL;
    if (TRUE == RULE_MGR_IS_ENTRY_ACTIVE(org_action.row_status))
        return RULE_TYPE_FAIL;
    /* no change */
...
UI32_T RULE_MGR_DelClassMap(UI32_T class_map_index)
{
    ...
    while (RULE_TYPE_OK == RULE_OM_GetClassMapElement(class_map_index, element_index, &element))
    {
        RULE_MGR_DelElementFromClassMap(class_map_index, &element);
...
UI32_T RULE_MGR_AddElement2ClassMap(UI32_T class_map_index, RULE_TYPE_UI_ClassMapElement_T *element_entry)
{
    ...
    if (RULE_TYPE_CLASS_MF == element_entry->class_type)
    {
        RULE_TYPE_Ace_Entry_T ace_entry;

        result = RULE_OM_Get_AceEntryByID(class_index, &ace_entry);
        if (RULE_TYPE_OK != result)
        {
            return result;
        }

        result = RULE_CTRL_PreAddRule(ace_entry.ace_type, FALSE);
        if (RULE_TYPE_OK != result)
        {
            return result;
        }
...
UI32_T RULE_MGR_DelElementFromClassMap(UI32_T class_map_index, RULE_TYPE_UI_ClassMapElement_T *element_entry)
{
    ...
    if (RULE_TYPE_CLASS_MF == element_entry->class_type)
    {
        result = RULE_CTRL_PostAddRule(ace_entry.ace_type, FALSE);
        if (RULE_TYPE_OK != result)
        {
            return result;
        }
    ...
    char   *time_range_name)
{
    ...
    if (time_range_name[0] != '\0' &&
        RULE_TYPE_OK != RULE_OM_GetTimeRangeIdByName(time_range_name, &time_range_index))
    {
        return RULE_TYPE_FAIL;
    }
    ...
    if (bind_acl.time_range_index == time_range_index)
    {
        return RULE_TYPE_OK;
    }
    ...
    return RULE_OM_SetPortEntryAclTimeRange(ifindex, direction, acl_type, time_range_index);
#else
    return RULE_TYPE_FAIL;
    ...
    UI32_T row_status)
{
    ...
    switch (L_RSTATUS_Fsm(row_status, &org_status, RULE_MGR_LocalAccessGroupRStatusCallBack, &bind_acl))
    {
        ...
        case L_RSTATUS_NOTREADY_2_ACTIVE:
            return RULE_MGR_LocalSetAccessGroupNotReady2Active(ifindex, direction, acl_type);

        case L_RSTATUS_ACTIVE_2_NOTREADY:
            return RULE_MGR_LocalSetAccessGroupActive2NotReady(ifindex, direction, acl_type);
...
#if (SYS_CPNT_TIME_BASED_ACL == TRUE)
    if (bind_acl_p->time_range_index == RULE_TYPE_UNDEF_TIME_RANGE)
    {
        memset(entry_p->time_range_name, 0, sizeof(entry_p->time_range_name));
    }
    else
    {
        RULE_MGR_GetTimeRangeNameByID(bind_acl_p->time_range_index,
                                      entry_p->time_range_name);
    }
   ...
   UI32_T policy_map_index)
{
    ...
    if (RULE_TYPE_OK != RULE_OM_SetPortEntryPolicyMapRowStatus(ifindex, direction,
                                      VAL_diffServPolicyMapPortPortStatus_notReady))
    {
        return RULE_TYPE_FAIL;
    }
    ...
    RULE_TYPE_COUNTER_ENABLE_T counter_enable)
{
    ...
    LOG("ifindex = %u, aclId = %u, aclType = %s, ingress = %s, timeRangeId = %hu, counter = %s",
        ifindex,
        acl_index,
    ...
    {
        RULE_MGR_DEBUG_MSG("Inactive ACL or wrong ACL type: row_status(%u), acl_type(%d)\n",
    ...
    if(RULE_TYPE_OK == RULE_OM_GetPortBindedAcl(ifindex, direction, acl_type, &bind_acl))
    {
        if (TRUE == RULE_MGR_IS_ENTRY_ACTIVE(bind_acl.row_status))
        {
            if (bind_acl.acl_index == acl_index &&
                ...
                bind_acl.time_range_index == time_range_index)
            {
                return RULE_TYPE_OK;
            }
    ...
    ASSERT(RULE_TYPE_OK== result);
    result = RULE_OM_SetPortEntryAclTimeRange(ifindex, direction, acl_type, time_range_index);
    ASSERT(RULE_TYPE_OK== result);
    ...
    if (result != RULE_TYPE_OK)
    {
        ...
        RULE_OM_SetPortEntryAclTimeRange(ifindex, direction, acl_type, bind_acl.time_range_index);
...
UI32_T RULE_MGR_UnBindPortFromAcl(UI32_T ifindex, UI32_T acl_index, RULE_TYPE_AclType_T acl_type, BOOL_T ingress_flag)
{
    ...
    LOG("ifindex = %u, aclId = %u, aclType = %s, ingress = %s",
        ifindex,
        acl_index,
        RULE_MGR_ACL_TYPE_STR(acl_type),
        (ingress_flag==TRUE)?"In":"Out");
    ...
    {
        LOG("ACL(%u) is not same with binded ACL(%u)", acl_index, bind_acl.acl_index)
        return RULE_TYPE_OK;
    }
    ...
    if (result != RULE_TYPE_OK)
    {
        LOG("Fail to unbind ACL(%u) on ifindex(%u)", acl_index, ifindex);
        return RULE_TYPE_FAIL;
    }
...
UI32_T RULE_MGR_BindPort2DynamicAcl(UI32_T uport_ifindex, UI32_T acl_index, RULE_TYPE_AclType_T acl_type, BOOL_T ingress_flag)
{
    ...
    UI16_T                      old_time_range_index;
    RULE_TYPE_AclMemento_T      acl_mem;

    RULE_MGR_DEBUG_MSG("RULE_MGR_BindPort2DynamicAcl(%u, %u, %s, %s)\n",
                       uport_ifindex,
                       acl_index,
                       RULE_MGR_ACL_TYPE_STR(acl_type),
                       (ingress_flag==TRUE)?"In":"Out");
    ...
    {
        RULE_MGR_DEBUG_MSG("Invalid port number: uport_ifindex(%u), uport_type(%d)\n",
                           uport_ifindex,
                           uport_type);
        return RULE_TYPE_FAIL;
    }
    ...
    {
        RULE_MGR_DEBUG_MSG("No bind dynamic ACL on this port(%u)\n",
                           uport_ifindex);
                                                        ...
                                                        &old_counter_enable))
        {
            ...
            acl_mem.time_range_index = old_time_range_index;
    ...
    BOOL_T ingress_flag)
{
    ...
    RULE_MGR_DEBUG_MSG("RULE_MGR_UnBindPortFromDynamicAcl(%u, %u, %s, %s)\n",
                       uport_ifindex,
                       acl_index,
                       RULE_MGR_ACL_TYPE_STR(acl_type),
                       (ingress_flag==TRUE)?"In":"Out");
    ...
    if (!RULE_OM_IsBindDyanmicAclOnPort(uport_ifindex, ingress_flag?RULE_TYPE_INBOUND:RULE_TYPE_OUTBOUND))
    {
        RULE_MGR_DEBUG_MSG("No any dynamic ACL on this port(%u)\n",
                           uport_ifindex);
        return RULE_TYPE_OK;
    }
    ...
    if (set_to_user_cfg)
    {
        ...
        RULE_MGR_DEBUG_MSG("No any dynamic ACL on this port(%u). Restore to user configured\n",
                           uport_ifindex);
 ...
 *------------------------------------------------------------------------------
 */
UI32_T RULE_MGR_GetNextUIAclByPortAndBindingType(UI32_T precedence, UI32_T *uport_ifindex, RULE_TYPE_UI_AclEntry_T *acl_entry)
{
    return RULE_OM_GetNextUIAclByPortAndBindingType(precedence, uport_ifindex, acl_entry);
}
...
UI32_T RULE_MGR_CreateAcl(const char *acl_name, RULE_TYPE_AclType_T acl_type)
{
    ...
    ret = RULE_CTRL_PreAddRule(acl_type, TRUE);
    if (RULE_TYPE_OK != ret)
    {
        RULE_OM_DelAcl(acl_index);
        return ret;
...
UI32_T RULE_MGR_DelAcl(UI32_T acl_index)
{
    ...
    result = RULE_CTRL_PostAddRule(acl_entry.acl_type, TRUE);
    if (RULE_TYPE_OK != result)
    {
        return result;
    }
...
UI32_T RULE_MGR_SetAce2Acl(UI32_T acl_index, RULE_TYPE_AclType_T acl_type, RULE_TYPE_Ace_Entry_T *ace_entry)
{
    ...
    for (i=0; i<_countof(acl_entry.filtering_in_port_list); i++)
    {
        if (acl_entry.filtering_in_port_list[i]!=0)
        {
            set_to_chip = TRUE;
            break;
        }
    }
    if (set_to_chip == FALSE)
    {
        for (i=0; i<_countof(acl_entry.filtering_out_port_list); i++)
        {
            if (acl_entry.filtering_out_port_list[i]!=0)
            {
                set_to_chip = TRUE;
                break;
            }
    ...
    if (set_to_chip == FALSE)
    {
        for (i=0; i<_countof(acl_entry.class_map_bit_list); i++)
        {
            if (acl_entry.class_map_bit_list[i]!=0)
            {
                set_to_chip = TRUE;
                break;
            }
    ...
    if (RULE_TYPE_OK != RULE_MGR_LocalUpdateChipCompressAclConfig(acl_index))
    {
        ...
        {
            ASSERT(0);
            RULE_MGR_DEBUG_MSG("UNDO failed. aclIndex=%u", acl_index);
        }
        return RULE_TYPE_FAIL;
    }
#else
    ...
    void *cookie)
{
    ...
    if (RULE_TYPE_OK != result)
    {
        LOG("<Error> Failed to clear counters. ifindex=%u, aclId=%u, aceId=%u",
    ...
    void *cookie)
{
    ...
    for (i = 0; i < RULE_TYPE_TOTAL_NBR_OF_PORT; ++ i)
    {
        ...
        else if (RULE_TYPE_INTERFACE_UNSPEC == interface_p->type)
        {
            if (TRUE == RULE_TYPE_IS_UPORT(ifindex))
            {
                UI32_T unit, port, trunk;
                ...
                lport_type = SWCTRL_LogicalPortToUserPort(ifindex,
                                                          &unit,
                                                          &port,
                                                          &trunk);
                if (SWCTRL_LPORT_NORMAL_PORT != lport_type)
            ...
            else if (TRUE == RULE_TYPE_IS_ALL_PORTS(ifindex))
            {
            }
            else
            {
 ...
 *------------------------------------------------------------------------------
 */
UI32_T RULE_MGR_SetAceFieldByIndex(UI32_T ace_index, const RULE_TYPE_Ace_Entry_T *ace_entry, UI32_T field_index)
{
    RULE_TYPE_RETURN_TYPE_T result;
...
#if (SYS_CPNT_ACL_MIRROR == TRUE)
/*------------------------------------------------------------------------
 * ROUTINE NAME - RULE_MGR_LocalSetAclMirrorDestinationPort
 *------------------------------------------------------------------------
 ...
 * OUTPUT  : None
 * RETURN  : TRUE/FALSE
 * NOTE    : Make sure the OM has been updated when disable
 *------------------------------------------------------------------------*/
BOOL_T
RULE_MGR_LocalSetAclMirrorDestinationPort(
    UI32_T ifindex_dest,
    UI32_T mirror_type,
    BOOL_T enable)
{
    UI32_T tmp_mirror_type;
    UI32_T tmp_acl_index = 0;
    RULE_TYPE_UI_AclEntry_T tmp_acl_entry;

#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
    BOOL_T rx_exist = FALSE, tx_exist = FALSE;
#endif

    if (enable == TRUE)
    {
        if (FALSE == SWCTRL_SetAclMirrorDestPort(ifindex_dest, mirror_type, TRUE))
        {
            return FALSE;
        }
    }
    ...
    {
#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
        while (RULE_TYPE_OK == RULE_OM_GetNextAclMirrorEntry(ifindex_dest, &tmp_acl_index,
                                                    &tmp_mirror_type, &tmp_acl_entry))
        {
            if (tmp_mirror_type == VAL_aclMirrorType_rx)
            {
                rx_exist = TRUE;
            }
            else if (tmp_mirror_type == VAL_aclMirrorType_tx)
            {
                tx_exist = TRUE;
            }
            else   /*VAL_aclMirrorType_both*/
            {
                rx_exist = TRUE;
                tx_exist = TRUE;
                break;
        ...
        if (rx_exist == FALSE && (mirror_type == VAL_aclMirrorType_both || mirror_type == VAL_aclMirrorType_rx))
        {
            if (FALSE == SWCTRL_SetAclMirrorDestPort(ifindex_dest, VAL_aclMirrorType_rx, FALSE))
            {
                return FALSE;
            }
        }
        if (tx_exist == FALSE && (mirror_type == VAL_aclMirrorType_both || mirror_type == VAL_aclMirrorType_tx))
        {
            if (FALSE == SWCTRL_SetAclMirrorDestPort(ifindex_dest, VAL_aclMirrorType_tx, FALSE))
            {
                return FALSE;
            }
        }
#else
        if (RULE_TYPE_OK != RULE_OM_GetNextAclMirrorEntry(ifindex_dest, &tmp_acl_index,
                                                    &tmp_mirror_type, &tmp_acl_entry))
        {
            if (FALSE == SWCTRL_SetAclMirrorDestPort(ifindex_dest, mirror_type, FALSE))
            {
                return FALSE;
            }
        }
    ...
    UI32_T mirror_type)
{
    ...
    UI32_T w_acl_index;
    UI32_T org_mirror_type = 0;
    RULE_TYPE_Acl_T acl_entry;

    /* only support VAL_aclMirrorType_rx now
     */
    if (mirror_type != VAL_aclMirrorType_rx)
    {
        RULE_MGR_DEBUG_MSG("SWCTRL_SetAclMirrorDestPort fail");
        return RULE_TYPE_INVALID_PARAMETER;
    }

    /*Set first due to it may fail*/
    if (FALSE == RULE_MGR_LocalSetAclMirrorDestinationPort(ifindex_dest, mirror_type, TRUE))
    {
        RULE_MGR_DEBUG_MSG("SWCTRL_SetAclMirrorDestPort fail");
    ...
    if (RULE_TYPE_OK != result)
    {
        RULE_MGR_LocalSetAclMirrorDestinationPort(ifindex_dest, mirror_type, FALSE);
        return result;
    }

    if (acl_entry.mirror.enable == TRUE
#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
        || acl_entry.mirror_egress.enable == TRUE
#endif
        )
    {
#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
        if (acl_entry.mirror.enable == RULE_TYPE_MIRROR_ENABLE &&
            acl_entry.mirror.dest_ifindex == ifindex_dest)
        {
            if (acl_entry.mirror_egress.enable == RULE_TYPE_MIRROR_ENABLE &&
                acl_entry.mirror_egress.dest_ifindex == ifindex_dest)
            {
                org_mirror_type = VAL_aclMirrorType_both;
            }
            else
            {
                org_mirror_type = VAL_aclMirrorType_rx;
            }
        }
        else if (acl_entry.mirror_egress.enable == RULE_TYPE_MIRROR_ENABLE &&
                 acl_entry.mirror_egress.dest_ifindex == ifindex_dest)
        {
            org_mirror_type = VAL_aclMirrorType_tx;
        }
#else
        org_mirror_type = VAL_aclMirrorType_rx;
#endif
    ...
    /* update mirror entry */
    /* 1. remove mirror entry */
    if (org_mirror_type != 0 && mirror_type != org_mirror_type)
    {
        if (RULE_TYPE_OK != RULE_OM_RemoveAclMirrorEntry(ifindex_dest, acl_index))
        {
            RULE_MGR_DEBUG_MSG("remove old setting fail");
        }
    }

    /* 2. add mirror_entry*/
    result = RULE_OM_AddAclMirrorEntry(ifindex_dest, acl_index, mirror_type);
    if (RULE_TYPE_OK != result)
    {
        RULE_MGR_DEBUG_MSG("RULE_OM_AddAclMirrorEntry fail");
        RULE_MGR_LocalSetAclMirrorDestinationPort(ifindex_dest, mirror_type, FALSE);
        return result;
    }

    /*remove old destination port setting (make sure OM has been updated!!)*/
    if (org_mirror_type != 0 && mirror_type != org_mirror_type)
    {
        if (TRUE != RULE_MGR_LocalSetAclMirrorDestinationPort(ifindex_dest, org_mirror_type, FALSE))
        {
            RULE_MGR_DEBUG_MSG("RULE_MGR_LocalSetAclMirrorDestinationPort fail");
        }
    }

    w_acl_index = acl_index;
#if (SYS_CPNT_ACL_AUTO_COMPRESS_ACE == TRUE)
    if (FALSE == acl_entry.flag_aggregate_done)
    {
        result = RULE_OM_RebuildAggregateAcl(acl_index);
        if (RULE_TYPE_OK != result)
        {
           RULE_MGR_DEBUG_MSG("RULE_OM_RebuildAggregateAcl fail");
           return result;
        }
    }
    ...
    if (RULE_TYPE_OK != result)
    {
        RULE_MGR_DEBUG_MSG("RULE_CTRL_SetAclMirror fail");
    ...
    UI32_T acl_index)
{
    ...
    if (FALSE == acl_entry.flag_aggregate_done)
    {
        RULE_MGR_DEBUG_MSG("aggregate fail");
        ASSERT(0);
    }
    w_acl_index = acl_entry.aggregate_acl_index;
#endif /* #if (SYS_CPNT_ACL_AUTO_COMPRESS_ACE == TRUE) */
    ...
    {
        RULE_MGR_DEBUG_MSG("RULE_CTRL_SetAclMirror fail");
        RULE_OM_AddAclMirrorEntry(ifindex_dest, acl_index, org_mirror_type);
    }
    else
    {
        if (TRUE != RULE_MGR_LocalSetAclMirrorDestinationPort(ifindex_dest, org_mirror_type, FALSE))
 ...
 *           acl_index      - ACL index
 * OUTPUT:   ifindex_dest   - Destination port
 *           acl_index      - ACL index
 *           mirror_type    - VAL_aclMirrorType_rx/VAL_aclMirrorType_tx/VAL_aclMirrorType_both
 *           acl_entry      - ACL entry
 * RETURN:   Error code.
    ...
    RULE_TYPE_UI_AclEntry_T *acl_entry)
{
    ...
    {
        *acl_index = 0;
        if (FALSE == SWCTRL_GetNextAclMirrorDestPort(ifindex_dest))
        {
            return RULE_TYPE_FAIL;
        }
    }
    ...
    do
    {
       if (RULE_TYPE_OK == RULE_OM_GetNextAclMirrorEntry(*ifindex_dest, acl_index, mirror_type, acl_entry))
       {
           return RULE_TYPE_OK;
       }
       *acl_index = 0;
    } while(TRUE == SWCTRL_GetNextAclMirrorDestPort(ifindex_dest));
...
UI32_T RULE_MGR_SetTcpPortCosMap(UI32_T unit, UI32_T port, UI16_T tcp_port, UI8_T cos_value, UI8_T mapping_index)
{
    ...
    if (FALSE == RULE_CTRL_SetL4PortCosMap(unit, port, tcp_port, cos_value))
        return RULE_TYPE_FAIL;
#endif /* #if (SYS_CPNT_COS_CONTAIN_CLI_MAP_IP_PORT == TRUE) */
    return RULE_TYPE_OK;
}
...
static UI32_T RULE_MGR_LocalSetAclNotReady(UI32_T acl_index)
{
...
#if (SYS_CPNT_ACL_MIRROR == TRUE)
    {
        if (acl_entry.mirror.enable == RULE_TYPE_MIRROR_ENABLE)
        {
            if (RULE_TYPE_OK != RULE_OM_RemoveAclMirrorEntry(acl_entry.mirror.dest_ifindex, acl_index))
            {
                RULE_MGR_DEBUG_MSG("remove old setting fail");
            }

            RULE_MGR_LocalSetAclMirrorDestinationPort(acl_entry.mirror.dest_ifindex, VAL_aclMirrorType_rx, FALSE);
        }

#if (SYS_CPNT_ACL_MIRROR_EGRESS == TRUE)
        if (acl_entry.mirror_egress.enable == RULE_TYPE_MIRROR_ENABLE)
        {
            if (RULE_TYPE_OK != RULE_OM_RemoveAclMirrorEntry(acl_entry.mirror_egress.dest_ifindex, acl_index))
            {
                RULE_MGR_DEBUG_MSG("remove old setting fail");
            }

            RULE_MGR_LocalSetAclMirrorDestinationPort(acl_entry.mirror_egress.dest_ifindex, VAL_aclMirrorType_tx, FALSE);
        }
...
#if (SYS_CPNT_TIME_BASED_ACL == TRUE)
                RULE_OM_CountTimeRangeRefCounter(port_time_range_index,  RULE_TYPE_TIME_RANGE_REF_COUNT_MINUS);
#endif /* SYS_CPNT_TIME_BASED_ACL */
            }
        }
    }
    ...
    {
        if (RULE_MGR_IS_DEBUG_ERROR_ON(RULE_OM_GetDebugFlag()))
            printf ("\r\n [RULE_MGR_LocalSetAclNotReady] fail_bitmap -> %X.", fail_bitmap);
    ...
    RULE_TYPE_AclType_T acl_type)
{
    ...
    LOG("ifindex = %u, direction = %s, aclType = %s",
        ifindex,
    ...
    if ((RULE_TYPE_OK != RULE_OM_GetAclByIndex(bind_acl.acl_index, &acl_entry)) ||
        ...
        (RULE_TYPE_OK != RULE_MGR_LocalCheckInputAclType(acl_entry.acl_type, acl_type)))
    {
        LOG("Inactive ACL or wrong ACL type: row_status(%u), acl_type(%d)",
    ...
    if (FALSE == acl_entry.flag_aggregate_done)
    {
        ...
        if (RULE_TYPE_OK != result)
        {
            LOG("RULE_OM_RebuildAggregateAcl fail");
            return result;
        }
    }
    acl_index = acl_entry.aggregate_acl_index;
    ...
    if (RULE_OM_IsBindDyanmicAclOnPort(ifindex, direction))
    {
        ...
        {
            RULE_OM_CountTimeRangeRefCounter(
                bind_acl.time_range_index, RULE_TYPE_TIME_RANGE_REF_COUNT_PLUS);
        }
#endif /* #if (SYS_CPNT_TIME_BASED_ACL == TRUE) */
    ...
    RULE_TYPE_AclType_T acl_type)
{
    ...
    if (RULE_OM_IsBindDyanmicAclOnPort(ifindex, direction))
    {
        RULE_MGR_DEBUG_MSG("Have bind dynamic ACL on this port(%u): clear ACL memento acl_type(%d)\n",
                           ifindex,
                           acl_type);
        ...
        {
            RULE_OM_CountTimeRangeRefCounter(
                bind_acl.time_range_index, RULE_TYPE_TIME_RANGE_REF_COUNT_MINUS);
        }
#endif /* #if (SYS_CPNT_TIME_BASED_ACL == TRUE) */
    ...
    if (bind_acl.time_range_index != RULE_TYPE_UNDEF_TIME_RANGE)
    {
        RULE_OM_CountTimeRangeRefCounter(bind_acl.time_range_index,
                                         RULE_TYPE_TIME_RANGE_REF_COUNT_MINUS);
    }
#endif /* #if (SYS_CPNT_TIME_BASED_ACL == TRUE) */
