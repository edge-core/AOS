...
#define L4_MGR_IS_ICMP_ACL(acl_protocol)           (acl_protocol == RULE_TYPE_ACL_ICMP_PROTOCOL)
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_CreateTimeRange
 *------------------------------------------------------------------------------
 * PURPOSE:  Create a time range.
 * INPUT:    p_time_range_name
 * OUTPUT:   NONE.
 * RETURN:   Error code.
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_CreateTimeRange(const char *time_range_name)
{
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_CreateTimeRange(time_range_name, &time_range_index);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_DeleteTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_DeleteTimeRange(const char *time_range_name)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_DeleteTimeRange(time_range_name);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_SetTimeRangeAbsolute
 *------------------------------------------------------------------------------
 * PURPOSE:  Set a time range absolute time and date.
 * INPUT:    p_time_range_name          - time range name
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_SetTimeRangeAbsolute(char *time_range_name,
                            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T *start_time,
                            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T *end_time )
{

    int                        second = 0; /* not used */
    RULE_TYPE_RETURN_TYPE_T    rm_ret;

    L4_MGR_USE_CSC_CHECK_OPER_MODE(RULE_TYPE_FAIL);

    /* convert start time to sec */
    if (NULL != start_time)
    {
        if (FALSE == SYS_TIME_ValidateTime(start_time->year,
                                           start_time->month,
                                           start_time->day,
                                           start_time->hour,
                                           start_time->minute,
        ...
        SYS_TIME_ConvertDateTimeToSeconds (start_time->year,
                                           start_time->month,
                                           start_time->day,
                                           start_time->hour,
                                           start_time->minute,
                                           second,
                                           &start_time->time_by_sec);
    }
    /* convert end time to sec */
    if (NULL != end_time)
    {
        if (FALSE == SYS_TIME_ValidateTime(end_time->year,
                                           end_time->month,
                                           end_time->day,
                                           end_time->hour,
                                           end_time->minute,
        ...
        SYS_TIME_ConvertDateTimeToSeconds (end_time->year,
                                           end_time->month,
                                           end_time->day,
                                           end_time->hour,
                                           end_time->minute,
                                           second,
                                           &end_time->time_by_sec);

    }

    L4_MGR_LOCK();
    rm_ret = RULE_MGR_SetTimeRangeAbsolute(time_range_name, start_time, end_time);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_DestoryTimeRangeAbsolute
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_DestoryTimeRangeAbsolute(char *p_time_range_name)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_DestoryTimeRangeAbsolute(p_time_range_name);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_SetTimeRangePeriodic
 *------------------------------------------------------------------------------
 * PURPOSE:  Set a time range periodic time and day.
 * INPUT:    p_time_range_name - time range name
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_SetTimeRangePeriodic(char *p_time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_SetTimeRangePeriodic(p_time_range_name, p_periodic_time);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_DestoryTimeRangePeriodic
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_ACL_DestoryTimeRangePeriodic(char *p_time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_DestoryTimeRangePeriodic(p_time_range_name, p_periodic_time);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_GetNextTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_GetNextTimeRange(UI16_T *p_time_range_index, RULE_TYPE_TIME_ACL_TIME_RANGE_T *p_time_range_entry)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_GetNextTimeRange(p_time_range_index, p_time_range_entry);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_GetTimeRangeIdByName
 *------------------------------------------------------------------------------
 * PURPOSE:  Get index of time range by it's name.
 * INPUT:    p_time_range_name
 * OUTPUT:   p_time_range_index
 * RETURN:   Error code (OK / FAIL)
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_GetTimeRangeIdByName(char *p_time_range_name, UI16_T *p_time_range_index)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_GetTimeRangeIdByName(p_time_range_name, p_time_range_index);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_GetTimeRangeNameByID
 *------------------------------------------------------------------------------
 * PURPOSE:  Get name of time range by it's ID.
 * INPUT:    time_range_index
 * OUTPUT:   p_time_range_name
 * RETURN:   Error code (OK / FAIL)
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_MGR_GetTimeRangeNameByID(UI16_T time_range_index, char *p_time_range_name)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_GetTimeRangeNameByID(time_range_index, p_time_range_name);
    L4_MGR_UNLOCK();
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_GetNextRunningTimeRange
 *------------------------------------------------------------------------------
 * PURPOSE:  Get next running time range entry by time range index
 * INPUT:    p_time_range_index - time range index
 *           p_time_range_entry - time range entry
 * OUTPUT:   p_time_range_index - time range index
 *           p_time_range_entry - time range entry
 ...
 *------------------------------------------------------------------------------
 */
SYS_TYPE_Get_Running_Cfg_T L4_MGR_ACL_GetNextRunningTimeRange(UI16_T *p_time_range_index, RULE_TYPE_TIME_ACL_TIME_RANGE_T *p_time_range_entry)
{
    UI32_T  ret;
    ...
    L4_MGR_LOCK();
    ret = RULE_MGR_GetNextTimeRange(p_time_range_index, p_time_range_entry);
    L4_MGR_UNLOCK();
...
void L4_MGR_HandleHotInsertion(UI32_T starting_port_ifindex, UI32_T number_of_port, BOOL_T use_default)
{
    ...
    L4_ACL_MGR_HandleHotInsertion(starting_port_ifindex,number_of_port,use_default);
#endif
#endif
#if(SYS_CPNT_COS == TRUE)
    ...
    L4_DS_MGR_HandleHotInsertion(starting_port_ifindex,number_of_port,use_default);
#endif
#endif
...
#if (SYS_CPNT_IPV6 == TRUE)
    L4_MGR_TRAP_PACKET_TO_CPU(RULE_TYPE_PacketType_IPV6_ALL_NODES);
    L4_MGR_TRAP_PACKET_TO_CPU(RULE_TYPE_PacketType_IPV6_ALL_ROUTERS);
#endif /* SYS_CPNT_IPV6 */
    ...
    RULE_TYPE_COUNTER_ENABLE_T counter_enable)
{
    ...
    if (NULL == time_range_name)
    {
        time_range_index = RULE_TYPE_UNDEF_TIME_RANGE;
    }
    else if ('\0' == time_range_name[0])
    {
        time_range_index = RULE_TYPE_UNDEF_TIME_RANGE;
    }
    else
    {
#if (SYS_CPNT_TIME_BASED_ACL == TRUE)
        if (RULE_MGR_GetTimeRangeIdByName(time_range_name, &time_range_index) != RULE_TYPE_OK)
        {
            L4_MGR_RETURN_AND_RELEASE_CSC(RULE_TYPE_INVALID_PARAMETER);
        }
#endif /* #if (SYS_CPNT_TIME_BASED_ACL == TRUE) */
 ...
 *------------------------------------------------------------------------------
 */
UI32_T L4_MGR_ACL_GetNextUIAclByPortAndBindingType(UI32_T precedence, UI32_T *uport_ifindex, RULE_TYPE_UI_AclEntry_T *acl_entry, UI16_T *time_range_index)
{
    RULE_TYPE_RETURN_TYPE_T    rm_ret;
    ...
    L4_MGR_LOCK();
    rm_ret = RULE_MGR_GetNextUIAclByPortAndBindingType(precedence, uport_ifindex, acl_entry);
    L4_MGR_UNLOCK();
    ...
    if (RULE_OM_IsBindDyanmicAclOnPort(uport_ifindex, inout_profile))
    {
        ...
        for (i=start; i<RULE_TYPE_MAX_NBR_OF_ACL_TYPE; ++i)
        {
            ...
            if (acl_mem.acl_index != 0)
            {
                ...
                *time_range_index   = acl_mem.time_range_index;
...
UI32_T L4_MGR_ACL_CreateAcl(const char *acl_name, RULE_TYPE_AclType_T acl_type)
{
    ...
    if (rm_ret == RULE_TYPE_OK)
    {
        ...
        SYS_CALLBACK_MGR_AclChanged(SYS_MODULE_ACL, acl_index, (char*)acl_name, ACL_CHANGE_TYPE_ADD);
    }
#endif /* SYS_CPNT_PBR */
...
UI32_T L4_MGR_ACL_DelAcl(const char *acl_name)
{
    ...
    if (rm_ret == RULE_TYPE_OK)
    {
        SYS_CALLBACK_MGR_AclChanged(SYS_MODULE_ACL, acl_index, (char*)acl_name, ACL_CHANGE_TYPE_DELETE);
    }
#endif /* SYS_CPNT_PBR */
    ...
    RULE_TYPE_UI_Ace_Entry_T *ace_entry)
{
    ...
    if (rm_ret == RULE_TYPE_OK)
    {
        SYS_CALLBACK_MGR_AclChanged(SYS_MODULE_ACL, acl_index, (char *)acl_name, ACL_CHANGE_TYPE_MODIFY);
    }
#endif /* SYS_CPNT_PBR */
    ...
    UI32_T mirror_type)
{
    ...
    ret = RULE_MGR_AddAclMirrorEntry(ifindex_dest, acl_index, mirror_type);
    ...
    RULE_TYPE_UI_AclEntry_T *acl_entry)
{
    ...
    ret = RULE_MGR_GetNextAclMirrorEntry(ifindex_dest, acl_index, mirror_type, acl_entry);
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_ACL_SetAclMirrorEntryForMib
 *------------------------------------------------------------------------------
 * PURPOSE:  Set ACL mirror entry for MIB
 * INPUT:    ifindex_dest   - Destination port
 *           acl_id         - Source ACL id
 *           mirror_type    - Mirror type
 *                           (VAL_aclMirrorType_rx/VAL_aclMirrorType_tx/VAL_aclMirrorType_both)
 *           mirror_status  - Mirror_status
 *                           (VAL_aclMirrorStatus_valid/VAL_aclMirrorStatus_invalid)
 * OUTPUT:   NONE
 * RETURN:   Error code.
 * NOTE:     NONE
 *------------------------------------------------------------------------------
 */
UI32_T
L4_MGR_ACL_SetAclMirrorEntryForMib(
    UI32_T ifindex_dest,
    UI32_T acl_index,
    UI32_T mirror_type,
    UI32_T mirror_status)
{
    ...
    if (mirror_status == VAL_aclMirrorStatus_valid)
    {
        ret = RULE_MGR_AddAclMirrorEntry(ifindex_dest, acl_index, mirror_type);
    }
    else
...
BOOL_T L4_MGR_Qos_GetNextDiffServClassMapIndexOfPolicyMap(UI32_T policy_map_index, UI32_T *class_map_index)
{
    ...
    int i;
    UI32_T next_class_map_index = 0xffff;
    RULE_TYPE_PolicyElement_T policy_element;

    L4_MGR_USE_CSC_CHECK_OPER_MODE(FALSE);

    if (RULE_TYPE_OK != RULE_MGR_GetPolicyMap(policy_map_index, &policy_map))
    {
        L4_MGR_RETURN_AND_RELEASE_CSC(FALSE);
    }
    ...
    {
        if (RULE_TYPE_OK != RULE_MGR_GetPolicyMapElement(
                                 policy_map.policy_map_element_index_list[i],
                                 &policy_element))
        {
            L4_MGR_RETURN_AND_RELEASE_CSC(FALSE);
        }

        if (policy_element.class_map_index < next_class_map_index &&
             policy_element.class_map_index > *class_map_index)
        {
            next_class_map_index = policy_element.class_map_index;
        }
    }

    if (next_class_map_index == 0xffff)
    {
        L4_MGR_RETURN_AND_RELEASE_CSC(FALSE);
    }
    else
    {
        *class_map_index = next_class_map_index;
        L4_MGR_RETURN_AND_RELEASE_CSC(TRUE);
    }
}
    ...
    if (ret == TRUE)
    {
        switch (row_status)
        {
            case VAL_diffServPolicyMapStatus_active:
                SYS_CALLBACK_MGR_AclChanged(SYS_MODULE_ACL, acl_index, acl_name, ACL_CHANGE_TYPE_ADD);
                break;

            case VAL_diffServPolicyMapStatus_destroy:
                SYS_CALLBACK_MGR_AclChanged(SYS_MODULE_ACL, acl_index, acl_name, ACL_CHANGE_TYPE_DELETE);
                break;
...
BOOL_T L4_MGR_QoS_SetDiffServAclAttachCtlAction(UI32_T acl_index, UI32_T ace_type, UI32_T ace_index, UI32_T attach_action)
{
    ...
    if (ret == TRUE)
    {
            ...
            acl_entry.row_status == VAL_diffServAclStatus_active)
        {
            ...
            SYS_CALLBACK_MGR_AclChanged(SYS_MODULE_ACL, acl_index, acl_name, ACL_CHANGE_TYPE_MODIFY);
        }
    }
#endif /* SYS_CPNT_PBR */
...
BOOL_T L4_MGR_QoS_SetDiffServIpAceProtocol(UI32_T ip_ace_index, UI32_T protocol_type)
{
    ...
    if ((TRUE  == L4_MGR_IS_ICMP_ACL(ace.ipv4.protocol.u.s.data)) &&
        (FALSE == L4_MGR_IS_ICMP_ACL(protocol_type)))
    {
        ace.icmp.icmp_type.op = RULE_TYPE_ICMP_ICMPTYPE_OP_NO_OPERATION;
    }

    if ((FALSE == L4_MGR_IS_ICMP_ACL(ace.ipv4.protocol.u.s.data)) &&
        (TRUE == L4_MGR_IS_ICMP_ACL(protocol_type)))
    {
        ace.l4_common.sport.op = VAL_diffServIpAceSourcePortOp_noOperator;
        ace.l4_common.dport.op = VAL_diffServIpAceSourcePortOp_noOperator;
    }
#endif
...
#if (SYS_CPNT_ACL_IP_EXT_ICMP == TRUE)
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_QoS_SetDiffServIpAceIcmpType
 *------------------------------------------------------------------------------
 * PURPOSE  : change control_code by ip_ace_index
 * INPUT    : ip_ace_index, icmp_type
 * OUTPUT   : none
 * RETURN   : TRUE -- succeeded / FALSE -- failed
 * NOTE     : none
 *------------------------------------------------------------------------------
 */
BOOL_T L4_MGR_QoS_SetDiffServIpAceIcmpType(UI32_T ip_ace_index, UI32_T icmp_type)
{
    BOOL_T                    ret;
    RULE_TYPE_UI_Ace_Entry_T  ace;
    ...
    if ((RULE_TYPE_OK != RULE_MGR_GetUIAceByIndex(ip_ace_index, &ace)) ||
        (FALSE == L4_MGR_IS_IP_ACL(ace.ace_type)) ||
        (FALSE == L4_MGR_IS_ICMP_ACL(ace.ipv4.protocol.u.s.data)))
    {
        L4_MGR_UNLOCK();
        L4_MGR_RETURN_AND_RELEASE_CSC(FALSE);
    }

    ace.icmp.icmp_type.op = RULE_TYPE_ICMP_ICMPTYPE_OP_EQUAL;
    ace.icmp.icmp_type.u.s.data = icmp_type;

    ret = (RULE_TYPE_OK == RULE_MGR_SetUIAceFieldByIndex(ip_ace_index,
                                                         &ace,
                                                         LEAF_diffServIpAceIcmpType));
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_MGR_QOS_SetPortEgressHybridQueueMode
 *------------------------------------------------------------------------------
 * PURPOSE:  This function sets the queue mode
 * INPUT:    l_port                - logic port
 *           mode                  - scheduling mode, COS_VM_SCHEDULING_METHOD_E
 *           strict_queue_bitmap   - strict queue bitmap, 1: strict, 0: WRR/DRR
 * OUTPUT:
 * RETURN:   COS_TYPE_ERROR_CODE_E
 * NOTE:     This function will set the config on user priority
 *------------------------------------------------------------------------------
...
L4_MGR_QOS_SetPortEgressHybridQueueMode(
    UI32_T l_port,
    UI32_T mode,
    UI32_T strict_queue_bitmap)
{
    COS_TYPE_ERROR_CODE_E        result = COS_TYPE_E_UNKNOWN;
    const UI16_T                 priority = COS_TYPE_PRIORITY_USER;

    L4_MGR_USE_CSC_CHECK_OPER_MODE(COS_TYPE_E_UNKNOWN);
    L4_MGR_LOCK();
    result = COS_VM_SetPortEgressHybridQueueMode(l_port, priority, mode, strict_queue_bitmap);
    L4_MGR_UNLOCK();
    L4_MGR_RETURN_AND_RELEASE_CSC(result);
}
...
BOOL_T L4_MGR_HandleIPCReqMsg(SYSFUN_Msg_T* ipcmsg_p)
{
    ...
    switch(cmd)
    {
        ...
        break;
#if (SYS_CPNT_TIME_BASED_ACL == TRUE)
        case L4_MGR_IPCCMD_ACL_CREATETIMERANGE:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_ui32=L4_MGR_ACL_CreateTimeRange(
                msg_data_p->data.acl_time_range.name);
        }
        break;

        case L4_MGR_IPCCMD_ACL_DELETETIMERANGE:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_ui32=L4_MGR_ACL_DeleteTimeRange(
                msg_data_p->data.acl_time_range.name);
        }
        break;

        case L4_MGR_IPCCMD_ACL_SETTIMERANGEABSOLUTE:
        {
            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T *p_start_absolute_time_date = NULL;
            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T *p_end_absolute_time_date = NULL;

            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            if (FALSE == msg_data_p->data.acl_time_range.start_is_null)
            {
                p_start_absolute_time_date = &msg_data_p->data.acl_time_range.start_absolute_time_date;
            }

            if (FALSE == msg_data_p->data.acl_time_range.end_is_null)
            {
                p_end_absolute_time_date = &msg_data_p->data.acl_time_range.end_absolute_time_date;
            }

            msg_data_p->type.result_ui32=L4_MGR_ACL_SetTimeRangeAbsolute(
                msg_data_p->data.acl_time_range.name,
                p_start_absolute_time_date,
                p_end_absolute_time_date);
        }
        break;

        case L4_MGR_IPCCMD_ACL_DESTORYTIMERANGEABSOLUTE:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_ui32=L4_MGR_ACL_DestoryTimeRangeAbsolute(
                msg_data_p->data.acl_time_range.name);
        }
       break;

        case L4_MGR_IPCCMD_ACL_SETTIMERANGEPERIODIC:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_ui32=L4_MGR_ACL_SetTimeRangePeriodic(
                msg_data_p->data.acl_time_range.name,
                &msg_data_p->data.acl_time_range.periodic_time);
        }
        break;

        case L4_MGR_IPCCMD_ACL_DESTORYTIMERANGEPERIODIC:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_ui32=L4_MGR_ACL_DestoryTimeRangePeriodic(
                msg_data_p->data.acl_time_range.name,
                &msg_data_p->data.acl_time_range.periodic_time);
        }
        break;

        case L4_MGR_IPCCMD_ACL_GETNEXTTIMERANGE:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE
                + sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range_entry);
            msg_data_p->type.result_ui32=L4_MGR_GetNextTimeRange(
                &msg_data_p->data.acl_time_range_entry.index,
                &msg_data_p->data.acl_time_range_entry.entry);
        }
        break;

        case L4_MGR_IPCCMD_ACL_GETTIMERANGEIDBYNAME:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE
                + sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range);
            msg_data_p->type.result_ui32=L4_MGR_GetTimeRangeIdByName(
                msg_data_p->data.acl_time_range.name,
                &msg_data_p->data.acl_time_range.index);
        }
        break;

        case L4_MGR_IPCCMD_ACL_GETTIMERANGENAMEBYID:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE
                + sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range);
            msg_data_p->type.result_ui32=L4_MGR_GetTimeRangeNameByID(
                msg_data_p->data.acl_time_range.index,
                msg_data_p->data.acl_time_range.name);
        }
        break;

        case L4_MGR_IPCCMD_ACL_GETNEXTRUNNINGTIMERANGE:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE
                + sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range_entry);
            msg_data_p->type.result_ui32=L4_MGR_ACL_GetNextRunningTimeRange(
                &msg_data_p->data.acl_time_range_entry.index,
                &msg_data_p->data.acl_time_range_entry.entry);
        }
        break;
        ...
        case L4_MGR_IPCCMD_ACL_GETNEXTACLBYPORT:
        {
            ...
            msg_data_p->type.result_ui32=L4_MGR_ACL_GetNextAclByPort(
                            ...
                            &msg_data_p->data.acluport_id_ui.time_range_index,
        ...
        case L4_MGR_IPCCMD_ACL_ADD_ACL_MIRROR_ENTRY:
        {
            ...
            msg_data_p->type.result_ui32 = L4_MGR_ACL_AddAclMirrorEntry(
                                    ...
                                    msg_data_p->data.port_aclname.mirror_type);
        }
        break;
        ...
        case L4_MGR_IPCCMD_ACL_GET_NEXT_ACL_MIRROR_ENTRY:
        {
            ...
            msg_data_p->type.result_ui32 = L4_MGR_ACL_GetNextAclMirrorEntry(
                            ...
                            &msg_data_p->data.port_aclid_aclentry.mirror_type,
        ...
        case L4_MGR_IPCCMD_ACL_SET_ACL_MIRROR_ENTRY_FOR_MIB:
        {
            ipcmsg_p->msg_size = L4_MGR_MSGBUF_TYPE_SIZE +
                                   sizeof(msg_data_p->data.port_aclid);
            msg_data_p->type.result_ui32 = L4_MGR_ACL_SetAclMirrorEntryForMib(
                            msg_data_p->data.port_aclid.uport_ifindex,
                            msg_data_p->data.port_aclid.acl_id,
                            msg_data_p->data.port_aclid.mirror_type,
                            msg_data_p->data.port_aclid.mirror_status);
        }
        break;
#endif /* #if (SYS_CPNT_ACL_MIRROR == TRUE) */
...
/* ========================================================================== */
        ...
        case L4_MGR_IPCCMD_QOS_GETNEXTDIFFSERVCLASSMAPINDEXOFPOLICYMAP:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE
                +sizeof(msg_data_p->data.ui32a1_ui32a2);
            msg_data_p->type.result_bool=L4_MGR_Qos_GetNextDiffServClassMapIndexOfPolicyMap(
                msg_data_p->data.ui32a1_ui32a2.ui32_a1,
                &msg_data_p->data.ui32a1_ui32a2.ui32_a2);
        }
        break;
...
#if (SYS_CPNT_ACL_IP_EXT_ICMP == TRUE)
        case L4_MGR_IPCCMD_QOS_SETDIFFSERVIPACEICMPTYPE:
        {
            ipcmsg_p->msg_size=L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_bool=L4_MGR_QoS_SetDiffServIpAceIcmpType(
                msg_data_p->data.ui32a1_ui32a2.ui32_a1,
                msg_data_p->data.ui32a1_ui32a2.ui32_a2);
        }
        break;
...
/* ========================================================================== */
        ...
        break;
        case L4_MGR_IPCCMD_QOS_SETPORTEGRESSHYBRIDQUEUEMODE:
        {
            ipcmsg_p->msg_size = L4_MGR_MSGBUF_TYPE_SIZE;
            msg_data_p->type.result_ui32 = L4_MGR_QOS_SetPortEgressHybridQueueMode(
                msg_data_p->data.port_hybrid_queue_mode.l_port,
                msg_data_p->data.port_hybrid_queue_mode.mode,
                msg_data_p->data.port_hybrid_queue_mode.strict_queue_bitmap
                );
        }
        break;
