...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_CreateTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_ACL_CreateTimeRange(const char *time_range_name)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
    ...
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_CREATETIMERANGE;

    /*assign input*/
    result = STRNCPY(msg_data_p->data.acl_time_range.name, time_range_name,
                                  sizeof(msg_data_p->data.acl_time_range.name));
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_DeleteTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_ACL_DeleteTimeRange(const char *time_range_name)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
                                                     + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T            *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_DELETETIMERANGE;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_SetTimeRangeAbsolute
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_ACL_SetTimeRangeAbsolute(const char *time_range_name,
                            ...
                            RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T *p_end_absolute_time_date )
{
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_SETTIMERANGEABSOLUTE;
    ...
    {
        msg_data_p->data.acl_time_range.start_is_null = TRUE;
    }
    else
    {
        msg_data_p->data.acl_time_range.start_is_null = FALSE;
        memcpy(&msg_data_p->data.acl_time_range.start_absolute_time_date, p_start_absolute_time_date,
            sizeof(RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T));
    }

    if (NULL == p_end_absolute_time_date)
    {
        msg_data_p->data.acl_time_range.end_is_null = TRUE;
    }
    else
    {
        msg_data_p->data.acl_time_range.end_is_null = FALSE;
        memcpy(&msg_data_p->data.acl_time_range.end_absolute_time_date, p_end_absolute_time_date,
            sizeof(RULE_TYPE_TIME_ACL_ABSOLUTE_TIME_DATE_T));
    }
    /*send ipc*/
    if(SYSFUN_SendRequestMsg(ipcmsgq_handle, msg_p, SYSFUN_TIMEOUT_WAIT_FOREVER,
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_DestoryTimeRangeAbsolute
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_ACL_DestoryTimeRangeAbsolute(const char *time_range_name)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
                                                     + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T            *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_DESTORYTIMERANGEABSOLUTE;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_SetTimeRangePeriodic
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_ACL_SetTimeRangePeriodic(const char *time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
                                                     + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T            *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_SETTIMERANGEPERIODIC;
    ...
    memcpy(&msg_data_p->data.acl_time_range.periodic_time, p_periodic_time,
        sizeof(RULE_TYPE_TIME_ACL_PERIODIC_TIME_T));
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_DestoryTimeRangePeriodic
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_ACL_DestoryTimeRangePeriodic(const char *time_range_name, RULE_TYPE_TIME_ACL_PERIODIC_TIME_T *p_periodic_time)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
                                                     + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T            *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_DESTORYTIMERANGEPERIODIC;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_GetNextTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_GetNextTimeRange(UI16_T *p_time_range_index, RULE_TYPE_TIME_ACL_TIME_RANGE_T *p_time_range_entry)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range_entry)
        + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T    *msg_p;
    L4_MGR_IPCMsg_T *msg_data_p;
    UI32_T          req_size, resp_size;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_GETNEXTTIMERANGE;

    /*assign input*/
    msg_data_p->data.acl_time_range_entry.index = *p_time_range_index;
    ...
    /*assign output*/
    *p_time_range_index = msg_data_p->data.acl_time_range_entry.index;
    memcpy(p_time_range_entry, &msg_data_p->data.acl_time_range_entry.entry,
        sizeof(RULE_TYPE_TIME_ACL_TIME_RANGE_T));

    return msg_data_p->type.result_ui32;
}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_GetTimeRangeIdByName
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_GetTimeRangeIdByName(const char *time_range_name, UI16_T *p_time_range_index)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
                                                     + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T            *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_GETTIMERANGEIDBYNAME;
    ...
    /*assign output*/
     *p_time_range_index = msg_data_p->data.acl_time_range.index;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_GetTimeRangeNameByID
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
RULE_TYPE_RETURN_TYPE_T L4_PMGR_GetTimeRangeNameByID(UI16_T time_range_index, char *time_range_name)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range)
        + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T    *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_GETTIMERANGENAMEBYID;

    /*assign input*/
    msg_data_p->data.acl_time_range.index = time_range_index;
    ...
    /*assign output*/
    STRNCPY(time_range_name, msg_data_p->data.acl_time_range.name,
             SYS_ADPT_MAX_LENGTH_OF_TIME_ACL_TABLE_NAME+1);

    return msg_data_p->type.result_ui32;
}

/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_GetNextRunningTimeRange
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
SYS_TYPE_Get_Running_Cfg_T L4_PMGR_ACL_GetNextRunningTimeRange(UI16_T *p_time_range_index, RULE_TYPE_TIME_ACL_TIME_RANGE_T *p_time_range_entry)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acl_time_range_entry)
        + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T    *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_GETNEXTRUNNINGTIMERANGE;
    ...
    RULE_TYPE_COUNTER_ENABLE_T counter_enable)
{
    ...
    if (time_range_name)
    {
        result = STRNCPY(msg_data_p->data.acluport_type_name_flag.time_range_name,
                         time_range_name,
                         sizeof(msg_data_p->data.acluport_type_name_flag.time_range_name));
        if (RULE_TYPE_OK != result)
        {
            return result;
        }
    ...
    RULE_TYPE_COUNTER_ENABLE_T *counter_enable)
{
    ...
    *time_range_index   = msg_data_p->data.acluport_id_ui.time_range_index;
 ...
 *------------------------------------------------------------------------------
 */
UI32_T L4_PMGR_ACL_GetNextUIAclByPortAndBindingType(UI32_T precedence, UI32_T *uport_ifindex, RULE_TYPE_UI_AclEntry_T *acl_entry, UI16_T *p_time_range_index)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.acluport_id_ui)
                                                     + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T    *msg_p;
    ...
    UI32_T mirror_type)
{
    ...
    msg_data_p->data.port_aclname.mirror_type = mirror_type;
    if (RULE_TYPE_OK != result)
    {
        return result;
    }
    ...
    RULE_TYPE_UI_AclEntry_T *acl_entry)
{
    ...
    *mirror_type  = msg_data_p->data.port_aclid_aclentry.mirror_type;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_GetNextRunningAclMirrorEntry
 *------------------------------------------------------------------------------
 * PURPOSE:  GetNext ACL mirror entry
 * INPUT:    ifindex_dest   - Destination port. Pass 0 to start.
 *           acl_index      - ACL index
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_ACL_SetAclMirrorEntryForMib
 *------------------------------------------------------------------------------
 ...
 */
UI32_T
L4_PMGR_ACL_SetAclMirrorEntryForMib(
    UI32_T ifindex_dest,
    UI32_T acl_index,
    UI32_T mirror_type,
    UI32_T mirror_status)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.port_aclid)
                                                    + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T            *msg_p;
    L4_MGR_IPCMsg_T         *msg_data_p;
    RULE_TYPE_RETURN_TYPE_T result;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_ACL_SET_ACL_MIRROR_ENTRY_FOR_MIB;

    /* assign input
     */
    msg_data_p->data.port_aclid.uport_ifindex = ifindex_dest;
    msg_data_p->data.port_aclid.acl_id = acl_index;
    msg_data_p->data.port_aclid.mirror_type = mirror_type;
    msg_data_p->data.port_aclid.mirror_status = mirror_status;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_Qos_GetNextDiffServClassMapIndexOfPolicyMap
 *------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
BOOL_T L4_PMGR_Qos_GetNextDiffServClassMapIndexOfPolicyMap(UI32_T policy_map_index, UI32_T *class_map_index)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.ui32a1_ui32a2)
        + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T    *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_QOS_GETNEXTDIFFSERVCLASSMAPINDEXOFPOLICYMAP;
    ...
    /*assign output*/
    *class_map_index = msg_data_p->data.ui32a1_ui32a2.ui32_a2;
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_QoS_SetDiffServIpAceIcmpType
 *------------------------------------------------------------------------------
 * PURPOSE  : change protocol_type by ip_ace_index
 ...
 *------------------------------------------------------------------------------
 */
BOOL_T L4_PMGR_QoS_SetDiffServIpAceIcmpType(UI32_T ip_ace_index, UI32_T icmp_type)
{
    const UI32_T msg_buf_size=(sizeof(((L4_MGR_IPCMsg_T *)0)->data.ui32a1_ui32a2)
        + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T *msg_p;
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_QOS_SETDIFFSERVIPACEICMPTYPE;

    /*assign input*/
    msg_data_p->data.ui32a1_ui32a2.ui32_a1=ip_ace_index;
    msg_data_p->data.ui32a1_ui32a2.ui32_a2=icmp_type;
...
//:COS_TO_DSCP
UI32_T L4_PMGR_QOS_SetIngressCos2Dscp(UI32_T ifindex,UI8_T cos,UI8_T cfi,UI8_T phb,UI8_T color)
{
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - L4_PMGR_QOS_SetPortEgressHybridQueueMode
 *------------------------------------------------------------------------------
 * PURPOSE:  This function sets the queue mode
 * INPUT:    l_port                - logic port
 *           mode                  - scheduling mode, COS_VM_SCHEDULING_METHOD_E
...
L4_PMGR_QOS_SetPortEgressHybridQueueMode(
    UI32_T l_port,
    UI32_T mode,
    UI32_T strict_queue_bitmap)
{
    const UI32_T    msg_buf_size = (sizeof(((L4_MGR_IPCMsg_T *)0)->data.port_hybrid_queue_mode)
                                   + L4_MGR_MSGBUF_TYPE_SIZE);
    SYSFUN_Msg_T    *msg_p;
    L4_MGR_IPCMsg_T *msg_data_p;
    UI8_T           space_msg[SYSFUN_SIZE_OF_MSG(msg_buf_size)];
    ...
    msg_data_p=(L4_MGR_IPCMsg_T *)msg_p->msg_buf;
    msg_data_p->type.cmd = L4_MGR_IPCCMD_QOS_SETPORTEGRESSHYBRIDQUEUEMODE;

    /* assign input */
    msg_data_p->data.port_hybrid_queue_mode.l_port = l_port;
    msg_data_p->data.port_hybrid_queue_mode.mode   = mode;
    msg_data_p->data.port_hybrid_queue_mode.strict_queue_bitmap = strict_queue_bitmap;
