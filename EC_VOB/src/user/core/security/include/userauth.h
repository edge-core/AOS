...
typedef enum
{
    USERAUTH_SESSION_ALL              = 0,
    USERAUTH_SESSION_CONSOLE          = VAL_trapVarSessionType_console,
    USERAUTH_SESSION_TELNET           = VAL_trapVarSessionType_telnet,
    USERAUTH_SESSION_SSH              = VAL_trapVarSessionType_ssh,
    USERAUTH_SESSION_HTTP             = VAL_trapVarSessionType_http,
    USERAUTH_SESSION_HTTPS            = VAL_trapVarSessionType_https,
    USERAUTH_NUMBER_OF_SESSION_TYPE   = USERAUTH_SESSION_HTTPS+1
...
#define USERAUTH_LOCALADDDEFAULTUSER_FUNC_NO            23
...
*/
#define USERAUTH_ID(id, name, psw, priv, sta) id,
#define USERAUTH_NAME(id, name, psw, priv, sta) name,
#define USERAUTH_PSW(id, name, psw, priv, sta) psw,
#define USERAUTH_PRIV(id, name, psw, priv, sta) priv,
#define USERAUTH_ACCOUNTINFO(id, name, psw, priv, sta)  {name,  psw, priv, sta },

#define USERAUTH_DFLTUSER_ACCOUNT(_) \
    _(USERAUTH_DFLT_ADMIN_USER, "admin", "admin", SYS_DFLT_USERAUTH_ADMIN_PRIVILEGE, USERAUTH_ENTRY_VALID) \
    _(USERAUTH_DFLT_GUEST_USER, "guest", "guest", SYS_DFLT_USERAUTH_GUEST_PRIVILEGE, USERAUTH_ENTRY_VALID)

enum
{
    USERAUTH_DFLTUSER_ACCOUNT(USERAUTH_ID)
    USERAUTH_MAX_DFLTACCOUNT_NUM
}USERAUTH_DFLT_USERACCOUNT_T;
...
enum
{
    ...
    USERAUTH_IPCCMD_GETRUNNINGALLLOGINLOCALUSER,
...
typedef struct
{
    ...
    union
    {
        ...
        {
            UI32_T user_count;
            USERAUTH_LoginLocal_T alluser_data_ar[SYS_ADPT_MAX_NBR_OF_LOGIN_USER + 2];
        }auth_account_data;
