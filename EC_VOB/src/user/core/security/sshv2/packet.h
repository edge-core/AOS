...
void	 packet_set_encryption_key(const char *, u_int, int);
...
/*extern int max_packet_size;*//*isiah*/
int      packet_set_maxsize(int);
/*#define  packet_get_maxsize() max_packet_size*//*isiah*/
I32_T    packet_get_maxsize(void);/*isiah. add*/
