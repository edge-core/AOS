 ...
 *************************************************************************/
	...
	U8                     L2_Sync_Flag ;
	U8                     PortsPriorityChanged;
	U8                     PriorityTable[MAX_CH_PER_SYSTEM];

	Layer2Reduction_t	   L2Reduction;
	U8                     bStaticPM_CalcMode;

	SystemParams_t  	   SystemParams;
	IcParams_t             IcParams[MAX_IC_ON_BOARD];
	ChannelParams_t		   ChannelParams[MAX_CH_PER_SYSTEM];

	Power_t 	           Budget[MAX_POWER_BUDGET];
	Masks_t                Masks;
	U8                     PriorityStep;
