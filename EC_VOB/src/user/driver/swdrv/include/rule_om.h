...
typedef struct
{
    ...
    RULE_TYPE_TIME_ACL_TIME_RANGE_T   time_range_table[SYS_ADPT_MAX_NBRS_OF_TIME_ACL_TABLE];
 ...
 *------------------------------------------------------------------------------
 */
UI32_T RULE_OM_GetNextAclByPortAndAclType(UI32_T uport_ifindex, UI32_T *acl_index, RULE_TYPE_UI_AclEntry_T *acl_entry, UI16_T *time_range_index);
 ...
 *------------------------------------------------------------------------------
 */
UI32_T RULE_OM_GetNextUIAclByPortAndBindingType(UI32_T precedence, UI32_T *uport_ifindex, RULE_TYPE_UI_AclEntry_T *acl_entry);
