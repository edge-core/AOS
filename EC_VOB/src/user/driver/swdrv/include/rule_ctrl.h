...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_UpdateTimeACLRelationRulePerPort
 *------------------------------------------------------------------------------
 * PURPOSE: Process timer alarm event from timer
 * INPUT:  None.
 * OUTPUT: None.
 ...
 *------------------------------------------------------------------------------
 */
BOOL_T RULE_CTRL_UpdateTimeACLRelationRulePerPort(UI32_T unit, UI32_T port, UI8_T *state_change_list);
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_PreAddRule
 *------------------------------------------------------------------------------
 * PURPOSE:  Reserve ACL/DiffServ group resource.
 * INPUT:    acl_type   - ACL type
 *           is_acl     - ACL or DiffServ
 * OUTPUT:   None
...
RULE_CTRL_PreAddRule(
    UI32_T acl_type,
    BOOL_T is_acl
);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_PostAddRule
 *------------------------------------------------------------------------------
 * PURPOSE:  Release ACL/DiffServ group resource.
 * INPUT:    acl_type   - ACL type
 *           is_acl     - ACL or DiffServ
 * OUTPUT:   None
 * RETURN:   RULE_TYPE_OK ; Error code
...
#endif /* SYS_CPNT_IPV6_MULTICAST_DATA_DROP*/
