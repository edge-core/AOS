...
#define SWDRV_TYPE_DEBUG_FLAG_GBIC_MAU_TYPE      BIT_5

#define SWDRV_TYPE_GBIC_INVALID_INFO_READ_ERROR           BIT_0
#define SWDRV_TYPE_GBIC_INVALID_INFO_CHECKSUM_BASE_ERROR  BIT_1
#define SWDRV_TYPE_GBIC_INVALID_INFO_CHECKSUM_EXT_ERROR   BIT_2
...
enum
{
    SWDRV_POWER_SOURCE_NONE = 0,
    SWDRV_POWER_SOURCE_UP,
    SWDRV_POWER_SOURCE_DOWN
};
/* PD operation mode:at/af
 */
enum
{
    SWDRV_POWERED_DEVICE_MODE_NONE = 0,
...
#define SWDRV_TYPE_GBIC_ID_QSFP28                   0x11
...
/* GBIC extended specification compliance codes
 */
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_AOC          0x01
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100GBASE_SR4      0x02
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100GBASE_LR4      0x03
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100GBASE_ER4      0x04
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100GBASE_SR10     0x05
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_CWDM4_FEC    0x06
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_PSM4         0x07
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_ACC          0x08
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_CWMD4_NO_FEC 0x09
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100GBASE_CR4      0x0B
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_25GBASE_CR_CA_S   0x0C
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_25GBASE_CR_CA_L   0x0D
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_40GBASE_ER4       0x10
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_10GBASE_SR_X4     0x11
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_40G_PSM4          0x12
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_G959_1_2KM        0x13
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_G959_1_40KM       0x14
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_G959_1_80KM       0x15
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_10GBASE_T_SFI     0x16
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_CLR4         0x17
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_AOC_2        0x18
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_AOC_3        0x19
#define SWDRV_TYPE_GBIC_EXT_COMP_CODES_100G_DWDM2        0x1A
...
/* SFP revision compliance
 */
#define SWDRV_TYPE_GBIC_REV_COMP_NOT_SPECIFIED          0x00
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_9_3       0x01
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_9_5       0x02
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_10_2      0x03
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_10_4      0x04
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_11_0      0x05
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_11_3      0x06
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_11_4      0x07
#define SWDRV_TYPE_GBIC_REV_COMP_SFF_8472_REV_12_0      0x08

/* QSFP revision compliance
 */
#define SWDRV_TYPE_QSFP_REV_COMP_NOT_SPECIFIED          0x00
#define SWDRV_TYPE_QSFP_REV_COMP_SFF_8436_REV_4_7       0x01
#define SWDRV_TYPE_QSFP_REV_COMP_SFF_8436_REV_4_7_EXT   0x02
#define SWDRV_TYPE_QSFP_REV_COMP_SFF_8636_REV_1_3       0x03
#define SWDRV_TYPE_QSFP_REV_COMP_SFF_8636_REV_1_4       0x04
#define SWDRV_TYPE_QSFP_REV_COMP_SFF_8636_REV_1_5       0x05
#define SWDRV_TYPE_QSFP_REV_COMP_SFF_8636_REV_2_0       0x06
...
{
    UI32_T  ifindex;
    char    connector_type[SWDRV_TYPE_GBIC_SNMP_CONNECTOR_FIELD_LENGTH + 2];
    char    fiber_type[SWDRV_TYPE_GBIC_SNMP_FIBER_TYPE_FIELD_LENGTH + 1];
    char    eth_comp_code[SWDRV_TYPE_GBIC_SNMP_ETH_COMPLIANCE_FIELD_LENGTH + 1];
    char    baud_rate[SWDRV_TYPE_GBIC_SNMP_BAUD_RATE_FIELD_LENGTH + 1];
    char    vendor_oui[SWDRV_TYPE_GBIC_SNMP_VENDOR_OUI_FIELD_LENGTH + 1];
    char    vendor_name[SWDRV_TYPE_GBIC_SNMP_VENDOR_NAME_FIELD_LENGTH + 1];
    char    vendor_pn[SWDRV_TYPE_GBIC_SNMP_VENDOR_PN_FIELD_LENGTH + 1];
    char    vendor_rev[SWDRV_TYPE_GBIC_SNMP_VENDOR_REV_FIELD_LENGTH + 1];
    char    vendor_sn[SWDRV_TYPE_GBIC_SNMP_VENDOR_SN_FIELD_LENGTH + 1];
    char    date_code[SWDRV_TYPE_GBIC_SNMP_DATE_CODE_FIELD_LENGTH + 1];
    char    error_msg[64];
...
{
    UI32_T  ifindex;
    char    temperature[SWDRV_TYPE_GBIC_SNMP_TEMP_FIELD_LENGTH + 1];     /* support_ddm == TRUE */
    char    voltage[SWDRV_TYPE_GBIC_SNMP_VCC_FIELD_LENGTH + 1];          /* support_ddm == TRUE */
    char    bias_current[SWDRV_TYPE_GBIC_SNMP_CURRENT_FIELD_LENGTH + 1]; /* support_ddm == TRUE */
    char    tx_power[SWDRV_TYPE_GBIC_SNMP_POWER_FIELD_LENGTH + 1];       /* support_ddm == TRUE */
    char    rx_power[SWDRV_TYPE_GBIC_SNMP_POWER_FIELD_LENGTH + 1];       /* support_ddm == TRUE */
...
{
    UI8_T  is_invalid;                                                 /* data valid or not */
...
#endif
    BOOL_T support_tx_disable:1;    /* bit4 of byte(195)*/
...
typedef struct SWDRV_IfTableStats_S
{
   ...
   UI64_T ifOutErrors;
   UI64_T ifOutQLen;
   char ifDateTime[40]; /* example "2017-02-17T14:03:36,833711595+0800" */
...
typedef enum    /*Bitmap*/
{
    SWDRV_HASH_SEL_SERVICE_ECMP =  0x00000001,
    SWDRV_HASH_SEL_SERVICE_TRUNK = 0x00000002,
} SWDRV_HashSelService_T;
...
} SWDRV_HashSelBlockInfo_T;

typedef struct 
{
    UI32_T   ref_service_bmp;
    UI8_T    list_index;
} SWDRV_HashSelBlockListMapping_T;
...
//            UI32_T  port;
        ...
        struct
        {
            ...
            SWDRV_HashSelBlockInfo_T block_info;
        } bind_hash_sel_for_service;
#endif
        
#if (SYS_CPNT_WRED == TRUE)
       SWDRV_RandomDetec_T random_detect;
#endif
...
typedef struct
{
    ...
    SWDRV_TYPE_SfpPresentStatus_T swdrv_port_sfp_present_status[SYS_ADPT_MAX_NBR_OF_UNIT_PER_STACK];
    BOOL_T  swdrv_port_sfp_present[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];/* identify sfp present or not */
    BOOL_T  swdrv_port_sfp_info_valid[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];/* identify sfp info valid or not */
    SWDRV_TYPE_SfpInfo_T swdrv_port_sfp_info[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
    SWDRV_TYPE_SfpDdmInfo_T swdrv_port_sfp_ddm_info[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
    UI8_T swdrv_port_sfp_ddm_info_raw[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT][SWDRV_TYPE_GBIC_EEPROM_MAX_LENGTH];

    #if (SYS_CPNT_SUPPORT_FORCED_1000BASE_T_MODE == TRUE)
    UI32_T workaround_status[SYS_ADPT_MAX_NBR_OF_PORT_PER_UNIT + 1];
    #endif

    UI32_T   swdrv_unit_bitmap;

    #if (SYS_CPNT_3COM_LOOPBACK_TEST == TRUE)
    UI8_T   swdrv_port_loopback_list[SYS_ADPT_NBR_OF_BYTE_FOR_1BIT_UPORT_LIST*SYS_ADPT_MAX_NBR_OF_UNIT_PER_STACK];
    #endif
    ...
    UI8_T  swdrv_port_local_admin_status[SYS_ADPT_NBR_OF_BYTE_FOR_1BIT_UPORT_LIST];
    UI8_T  swdrv_port_local_admin_status_dirty[SYS_ADPT_NBR_OF_BYTE_FOR_1BIT_UPORT_LIST];
    BOOL_T swdrv_pse_check_enable;
#endif

    BOOL_T swdrv_thread_idle;

    BOOL_T swdrv_task_is_transition_done;

#if (SYS_HWCFG_SFP_PRESENT_STATUS_ACCESS_METHOD != SYS_HWCFG_REG_ACCESS_METHOD_I2C_WITH_CHANNEL)
    UI32_T swdrv_sfp_present_status_addr[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
#endif
    UI8_T  swdrv_sfp_present_mask[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
#if defined(SYS_HWCFG_SFP_MODULE_PRESENT_BIT_SHIFT_ARRAY_BODY)
    UI8_T  swdrv_sfp_present_bit_shift[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
#endif
#if (SYS_HWCFG_GBIC_HAS_RX_LOS==TRUE)
    UI32_T swdrv_sfp_rx_los_status_addr[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
    UI8_T  swdrv_sfp_rx_los_mask[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
    UI8_T  swdrv_sfp_rx_los_bit_shift[SYS_ADPT_NBR_OF_SFP_PORT_PER_UNIT];
#endif
    UI32_T swdrv_sfp_present_delay_ticks;

#if (SYS_CPNT_HASH_SELECTION == TRUE)
    SWDRV_HashSelBlockListMapping_T  hash_block[SYS_ADPT_HW_HASH_SELECTION_BLOCK_SIZE];
#endif
