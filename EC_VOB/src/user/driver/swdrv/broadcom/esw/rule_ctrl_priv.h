...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_CreateGroup
 *------------------------------------------------------------------------------
...
RULE_CTRL_CreateGroup(
    RULE_TYPE_FunctionType_T fun_type
);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_DeleteGroup
 *------------------------------------------------------------------------------
...
static BOOL_T RULE_CTRL_TrapArpReplyToCPU(BOOL_T enable);
static BOOL_T RULE_CTRL_TrapArpRequestToCPU(BOOL_T enable);
...
static RULE_TYPE_RETURN_TYPE_T RULE_CTRL_LocalConvertMacAce2DevAce(const RULE_TYPE_MacAce_Entry_T *mac_ace, DEVRM_AceEntry_T *dev_ace);
static RULE_TYPE_RETURN_TYPE_T RULE_CTRL_LocalConvertIpAce2DevAce(const RULE_TYPE_IpAce_Entry_T *ip_ace, DEVRM_AceEntry_T *dev_ace);
static RULE_TYPE_RETURN_TYPE_T RULE_CTRL_LocalConvertIpv6Ace2DevAce(const RULE_TYPE_Ipv6Ace_Entry_T *ipv6_ace, DEVRM_AceEntry_T *dev_ace);
static RULE_TYPE_RETURN_TYPE_T RULE_CTRL_LocalConvertIpv6Ace2ExtDevAce(const RULE_TYPE_Ipv6Ace_Entry_T *ipv6_ace, DEVRM_AceEntry_T *dev_ace);
static RULE_TYPE_RETURN_TYPE_T RULE_CTRL_LocalConvertIpv6Ace2StdDevAce(const RULE_TYPE_Ipv6Ace_Entry_T *ipv6_ace, DEVRM_AceEntry_T *dev_ace);
...
RULE_CTRL_AddRule2DevForAclPurpose(
    ...
    const RULE_TYPE_Ace_Entry_T *ace_entry,
    UI32_T ace_index,
    DEVRM_ActionEntry_T *Obsoleted_dev_action_list_p,
    RULE_TYPE_COUNTER_ENABLE_T counter_enable,
    const DEVRM_AceEntry_T *rule_pattern_p,
    const DEVRM_ActionEntry_T *dev_action_list_p,
...
static RULE_TYPE_RETURN_TYPE_T
RULE_CTRL_LocalConvertMeter2Dev_2(
    const RULE_TYPE_TBParamEntry_T *meter_entry,
    DEVRM_ACTION_T *dev_action_p);

static void
RULE_CTRL_LocalConvertCounter2Dev(
    const RULE_TYPE_Action_T *action_entry_p,
    DEVRM_CounterEntry_T *dev_counter_entry
);
...
static RULE_TYPE_RETURN_TYPE_T
RULE_CTRL_Update_ACE_PortBitMap(
    const RULE_TYPE_INTERFACE_INFO_PTR_T interface_p,
    const RULE_TYPE_CLASS_INSTANCE_PTR_T acl_inst_p,
    const RULE_TYPE_CLASS_INSTANCE_PTR_T ace_inst_p,
    BOOL_T is_add
);

static RULE_TYPE_RETURN_TYPE_T
RULE_CTRL_Update_ACE_PortBitMap_2(
    const RULE_TYPE_INTERFACE_INFO_PTR_T interface_p,
    const RULE_TYPE_CLASS_INSTANCE_PTR_T acl_inst_p,
    const RULE_TYPE_CLASS_INSTANCE_PTR_T ace_inst_p,
    BOOL_T is_add
...
#if 0 /*use RULE_CTRL_RequestGroupResource instead*/
/*------------------------------------------------------------------------------
...
static void RULE_CTRL_FreeDevActionListMemory(DEVRM_ActionEntry_T *dev_action_list_p);
...
static RULE_TYPE_RETURN_TYPE_T
RULE_CTRL_Priv_Class_Instance_To_Interface(
    const RULE_TYPE_CLASS_INSTANCE_PTR_T class_inst_p,
    RULE_TYPE_INTERFACE_INFO_PTR_T interface_p
);
...
static RULE_TYPE_CLASS_INSTANCE_PTR_T
RULE_CTRL_Priv_GetClassInstanceOfRuleEntry_Ignore_Port(
    RULE_TYPE_CLASS_INSTANCE_OBJECT_T *class_inst_obj_p,
    const DEVRM_AceEntry_T *rule_pattern_p
);
...
////////////////////////////////////////////////////////////////////////////////
//
// FIXME: Temp area for mergeing code
//
static RULE_TYPE_RETURN_TYPE_T
...
////////////////////////////////////////////////////////////////////////////////
    ...
    static BOOL_T RULE_CTRL_Slave_Share_Counter(ISC_Key_T *key, RULE_CTRL_IscBuf_T *ptr);
    static BOOL_T RULE_CTRL_Slave_GetGroupStstus(ISC_Key_T *key, RULE_CTRL_IscBuf_T *ptr);
    static BOOL_T RULE_CTRL_Slave_GetTotalEntriesOfFreeSlice(ISC_Key_T *key, RULE_CTRL_IscBuf_T *ptr);
    static BOOL_T RULE_CTRL_Slave_Create_Group(ISC_Key_T *key, RULE_CTRL_IscBuf_T *ptr);
    static BOOL_T RULE_CTRL_Slave_Destroy_Group(ISC_Key_T *key, RULE_CTRL_IscBuf_T *ptr);
#endif
...
RULE_CTRL_Set_Rule(
    ...
    UI32_T group_id,
    UI32_T dev_rule_id,
    const DEVRM_AceEntry_T *ace_entry,
    DEVRM_MeterEntry_T *meter_entry,
    const DEVRM_ActionEntry_T *action_entry,
...
static BOOL_T RULE_CTRL_Share_Counter(UI32_T unit, UI32_T device_id, UI32_T src_rule_id, UI32_T dev_rule_id);
static BOOL_T RULE_CTRL_Local_Share_Counter(UI32_T device_id, UI32_T src_rule_id, UI32_T dev_rule_id);
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_RequestGroupResource
 *------------------------------------------------------------------------------
 * PURPOSE:  Request rule from the specified group
 * INPUT:    unit             - Unit id
 *           device_id        - Device id
 *           group_id         - Group id
 *           request_type     - Request type (test, allocate or free)
 *           rule_count       - How many rule need
 * OUTPUT:   None
 * RETURN:   TRUE/FALSE
 * NOTE: Allocate must be used after chip allocation.
 *------------------------------------------------------------------------------
 */
static BOOL_T
RULE_CTRL_RequestGroupResource(
    UI32_T unit,
    UI32_T device_id,
    UI32_T group_id,
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_Priv_GetCraftPortInfo
 *------------------------------------------------------------------------------
 * PURPOSE:  Get the device id and port id of craft port
 * INPUT:    None
 * OUTPUT:   device_id_p     -- device id of craft port
 *           device_port_id  -- port id of craft port
 * RETURN:   OK / FAIL
 * NOTE:
 *------------------------------------------------------------------------------
 */
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_LocalAddRule_To_Dev
 *------------------------------------------------------------------------------
 * PURPOSE  : allocate and set rule to device
 * INPUT    : unit            -- which unit
 *            device_id       -- which device
 *            interface_p     -- interface info
 *            ace_index       -- ACE id
 *            group_id        -- required group
 *            ace_entry_p     -- ACE entry
 *            ace_inst_obj_p  -- ACE object
 *            dev_action_p    -- device action set from ACL
 *            fun_type        -- required function type
 *            counter_enable  -- counter enable/disable
 *            is_active       -- rule is active or not
 *            priority        -- rule priority
 * OUTPUT   : None
 * RETURN   : RULE_TYPE_OK -- OK
 *            RULE_TYPE_INSUFFICIENT_RESOURCE -- insufficient resource
 * NOTE     : None
 *------------------------------------------------------------------------------
 */
static RULE_TYPE_RETURN_TYPE_T
 ...
 * INPUT:    pbr_action_p
 * OUTPUT:   None
 * RETURN:   dev_action_head_p / NULL - Fail
 * NOTE:     None
 *------------------------------------------------------------------------------
 */
static DEVRM_ActionEntry_T*
 ...
 */
static RULE_TYPE_RETURN_TYPE_T
RULE_CTRL_Priv_ConvertPBRAction2DEV_2(
 ...
 *           priority       - Rule priority (Larger number mean higher priority.)
 * OUTPUT:   None.
 * RETURN:   RULE_TYPE_OK / Error code (RULE_TYPE_RETURN_TYPE_T)
 * NOTE:     None
 *------------------------------------------------------------------------------
...
RULE_CTRL_LocalAddPbrRule_To_Dev(
    ...
    RULE_TYPE_CLASS_INSTANCE_OBJECT_T *ace_inst_obj_p,
    UI32_T ace_index,
    const DEVRM_AceEntry_T *dev_ace_entry_p,
    const DEVRM_ACTION_T *new_dev_action_p,
    const DEVRM_ActionEntry_T *dev_action_p,
    int priority
);
 ...
 *           seq_num     - The match sequence number (smaller number mean higher priority.)
...
RULE_CTRL_LocalConvertAction2DEV(
    const RULE_TYPE_InOutDirection_T direction,
    const RULE_TYPE_Action_T *action_entry,
    DEVRM_ACTION_T *dev_action_p
);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_GetGroupStatus
 *------------------------------------------------------------------------------
 * PURPOSE:  get group status
 * INPUT:    unit id, device id, group id
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - RULE_CTRL_GetTotalEntriesOfFreeSlice
 *------------------------------------------------------------------------------
 ...
 */
static BOOL_T
RULE_CTRL_GetTotalEntriesOfFreeSlice(
    UI32_T unit,
    UI32_T device_id,
    UI32_T *entry_nbr
);
