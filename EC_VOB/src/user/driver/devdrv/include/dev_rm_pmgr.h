...
#include "sys_type.h"
#ifdef MARVELL_CPSS /* Yongxin.Zhao added,  2009-05-13, 15:21:32 */
    ...
    union
    {
        ...
        union
        {
            struct
            {
                ...
                BOOL_T  counter_enable;    // FOR MVL
                UI32_T  counter_entry_num; // FOR BCM
                DEVRM_AceEntry_T    ace_entry;
...
enum
{
    ...
    DEVRM_IPCCMD_SHARE_COUNTER,
    DEVRM_IPCCMD_GET_GROUP_STATUS,
    DEVRM_IPCCMD_GET_FREE_ENTRIES,
};
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEVRM_PMGR_ShareCounter
 *------------------------------------------------------------------------------
 * PURPOSE:  share counter
 * INPUT:    device id, src rule id, dst rule id
 * OUTPUT:   none
 * RETURN:   TRUE/FALSE.
 * NOTE:     NONE
 *------------------------------------------------------------------------------
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEVRM_PMGR_GetGroupStatus
 *------------------------------------------------------------------------------
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEVRM_PMGR_GetTotalEntriesOfFreeSlice
 *------------------------------------------------------------------------------
 ...
 */
BOOL_T
DEVRM_PMGR_GetTotalEntriesOfFreeSlice(
    UI32_T device_id,
    UI32_T *entry_nbr
);
#endif
...
DEVRM_PMGR_SetRule(
    ...
    UI32_T dev_rule_id,
    DEVRM_AceEntry_T    *ace_entry,
//    DEVRM_POLICER_INFO_T *policer_info,
 ...
 * INPUT    : None
 * OUTPUT   : dev_info_p->num_of_chips
 *            dev_info_p->port_bit_map (broadcom)
 * RETURN   : TRUE/FALSE
 * NOTE     : NONE
 *------------------------------------------------------------------------------
 */
