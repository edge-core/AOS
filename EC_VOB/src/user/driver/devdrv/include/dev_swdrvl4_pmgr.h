...
typedef struct
{
	...
	union
        ...
        }setportcosgroupschedulingmethod;
#endif
#if (SYS_CPNT_CN == TRUE)
        union
        {
...
enum
{
    ...
    DEV_SWDRVL4_IPCCMD_SETSTRICTPRIORITYQUEUE,
    DEV_SWDRVL4_IPCCMD_SETWRRQUEUEWEIGHT,
    ...
    DEV_SWDRVL4_IPCCMD_SETPORTCOSGROUPMAPPING,          /* SYS_CPNT_ETS */
    DEV_SWDRVL4_IPCCMD_SETPORTCOSGROUPSCHEDULINGMETHOD, /* SYS_CPNT_ETS */
    DEV_SWDRVL4_IPCCMD_SETQCNCNMPRIORITY,               /* SYS_CPNT_CN */
    DEV_SWDRVL4_IPCCMD_SETPORTQCNCPQ,                   /* SYS_CPNT_CN */
    DEV_SWDRVL4_IPCCMD_SETPORTQCNEGRCNTAGREMOVAL,       /* SYS_CPNT_CN */
    DEV_SWDRVL4_IPCCMD_GETPORTQCNCPID,                  /* SYS_CPNT_CN */
};
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetWrrQueueWeight
 *------------------------------------------------------------------------------
 * FUNCTION: This function sets WRR queue weight
 * INPUT   : q_id     -- which queue to set
 ...
 *           among queues
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetWrrQueueWeight(
        UI32_T q_id,
        UI32_T weight);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetStrictPriorityQueue
 *------------------------------------------------------------------------------
 * FUNCTION: This function sets strict priority queue
 * INPUT   : q_id     -- which queue to set
 * OUTPUT  : None
 * RETURN  : True: Successfully, FALSE: failed
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetStrictPriorityQueue(UI32_T q_id);
...
#if (SYS_CPNT_ETS == TRUE)
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetPortCosGroupMapping
 *------------------------------------------------------------------------------
 ...
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetPortCosGroupMapping(
    UI32_T unit,
    UI32_T port,
    UI32_T cosq2group[SYS_ADPT_MAX_NBR_OF_PRIORITY_QUEUE]);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetPortCosGroupSchedulingMethod
 *------------------------------------------------------------------------------
 ...
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetPortCosGroupSchedulingMethod(
    UI32_T unit,
    UI32_T port,
    DEV_SWDRVL4_EgressSchedulingMethod_T method,
    UI32_T weights[SYS_ADPT_ETS_MAX_NBR_OF_TRAFFIC_CLASS]);
...
#if (SYS_CPNT_CN == TRUE)
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetQcnCnmPriority
 *------------------------------------------------------------------------------
 ...
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetQcnCnmPriority(UI32_T pri);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetPortQcnCpq
 *------------------------------------------------------------------------------
 ...
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetPortQcnCpq(
    UI32_T unit,
    UI32_T port,
    UI32_T cosq,
    UI32_T cpq);
...
/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_SetPortQcnEgrCnTagRemoval
 *------------------------------------------------------------------------------
 ...
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_SetPortQcnEgrCnTagRemoval(
    UI32_T unit,
    UI32_T port,
    UI8_T no_cntag_bitmap);

/*------------------------------------------------------------------------------
 * ROUTINE NAME - DEV_SWDRVL4_PMGR_GetPortQcnCpid
 *------------------------------------------------------------------------------
 ...
 * NOTE    : None
 *------------------------------------------------------------------------------*/
BOOL_T DEV_SWDRVL4_PMGR_GetPortQcnCpid(
    UI32_T unit,
    UI32_T port,
    UI32_T cosq,
    UI8_T cpid[8]);
