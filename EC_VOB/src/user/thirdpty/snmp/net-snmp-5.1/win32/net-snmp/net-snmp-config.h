...
/*#define RAND_MAX 32767 kinghong remove for clear warning message*/
...
/*  This is defined the UDPIPv6 transport specification string
 *  (porting from Galaxy)
 */
#define NETSNMP_TRANSPORT_CONFIG_STR       "udp6:[::%0]:161,udp:161"
...
/* kinghong marked out the header files since our VXWORKS system don't need this*/
#ifndef VXWORKS
typedef unsigned short mode_t;
#endif
