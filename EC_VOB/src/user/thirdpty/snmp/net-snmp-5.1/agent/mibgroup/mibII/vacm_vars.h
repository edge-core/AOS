...
config_add_mib(SNMP-COMMUNITY-MIB)
     ...
     #ifndef VXWORKS
     void            vacm_parse_group(const char *, char *, BOOL_T is_auto_create);
     void            vacm_parse_access(const char *, char *, BOOL_T is_auto_create);
     void            vacm_parse_view(const char *, char *);
     #else
     UI32_T          vacm_parse_group(const char *, char *, BOOL_T is_auto_create);
     UI32_T          vacm_parse_access(const char *, char *, BOOL_T is_auto_create);
     UI32_T          vacm_parse_view(const char *, char *);
     #endif
