...
{
   return snmpNotifyFilterProfileTableStorage;
}
                                 ...
                                 *thedata)
{
    ...
    UI32_T  notify_filter_profile_counter;
    ...
    SNMP_MGR_GetSnmpV3NotifyFilterProfileCounter(& notify_filter_profile_counter);
    
   
    /*kinghong added*/
    if (notify_filter_profile_counter >= SNMP_MGR_MAX_NBR_OF_NOTIFY_FILTER_PROFILE_ENTRY)
        return SNMPERR_SUCCESS;
    
     SNMP_MGR_AdjustSnmpV3NotifyFilterProfileCounter(TRUE);
