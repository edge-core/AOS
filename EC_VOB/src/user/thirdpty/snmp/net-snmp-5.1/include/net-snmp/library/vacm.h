...
#define VACM_MODE_CHECK_SUBTREE       2
   ...
   struct vacm_accessEntry *vacm_getExactAccessEntry(const char *groupName,
                                                     const char *contextPrefix,
                                                     int securityModel, int securityLevel);
   struct vacm_groupEntry *vacm_get_groupList(void);
   struct vacm_viewEntry *vacm_get_viewList(void);
