...
#define USM_3DES_SALT_LENGTH            192     /* In BITS. */
...
#define USM_SEC_MODEL_NUMBER            3
    ...
    struct usmUser {
        ...
        struct usmUser *prev;
        #ifdef VXWORKS
        /*kinghong added for Accton running cfg issue*/
        int             userModel;
        int             userSecLevel;
        char          *groupName;
        int             authType;
        ...
        /* The entry is created automatically and not modified by user. It needs
         * to be deleted automatically when it's not used by anyone.
         */
        BOOL_T          is_auto_destroy;
    };
    ...
    /* add for snmpv3 3DES
     */
    int             usm_set_3dessalt(const oid * authtype,
    ...
    int usm_get_engineID_from_user_name(u_char* user_name, u_char* enginedID, size_t 
    *engineIDLen);
