/* MODULE NAME:  l_ipcmem_type.h
 * PURPOSE:
 *  Private definitions for L_IPCMEM.
 *
 * NOTES:
 *
 * HISTORY
 ...
 */
#ifndef L_IPCMEM_TYPE_H
#define L_IPCMEM_TYPE_H
...
#define L_IPCMEM_TYPE_MARVELL_CPSS_DFLT_TX_MREF_SZ (2*1024*1024) /* 2 MBytes */
...
enum
{
    ...
    L_IPCMEM_CMD_GET_IPCMEM_TOTAL_SIZE,
    L_IPCMEM_CMD_GET_OFFSET,
    L_IPCMEM_CMD_GET_PTR,
    L_IPCMEM_CMD_PREINITIALIZE_SETKERNELSPACEADDRINFO,
};
