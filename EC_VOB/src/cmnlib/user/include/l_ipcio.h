 ...
 */
#define L_IPCIO_MAX_LENGTH_OF_ARG_BUF 1024
 ...
 * NOTE    : None.
 *----------------------------------------------------------------*/
#define L_IPCIO_SIZE_OF_MSG(arg_size) (offsetof(L_IPCIO_Msg_T, ipcio_arg_buffer) + (arg_size))

/* DATA TYPE DECLARATIONS
 */
/* Used for I/O service provider to identify which user request
 * I/O operation.
 * This parameter is transparent to L_IPCIO and I/O service provider
 * is responsible for user_info allocation.
 */
typedef struct
{
    UI32_T user_id;
