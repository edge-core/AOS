...
#define NULL_INDEX            ((L_HASH_Index_T)-1)
#define KEY_SEGMENT_BYTES     2
#define MAX_KEY_LENGTH        32
#define HASH_WK               ((L_HASH_WorkSpace_T *)(((L_HASH_Desc_T*)desc)->buffer))
#define HASH_RECORD(ridx)     ((UI8_T *)(HASH_WK->data_rec_ptr) + (HASH_WK->hash_rec_len * (ridx)))
 ...
 */
static UI32_T L_HASH_DeleteQueryGroup_Callback(L_HASH_Index_T index,void *cookie);
 ...
 *---------------------------------
 */
static UI32_T L_HASH_ShMem_DeleteQueryGroup_Callback(L_HASH_Index_T index,void *cookie);
...
BOOL_T L_HASH_Create (L_HASH_Desc_T  *desc)
{
     ...
     */
    wk->hash_header_ptr = (L_HASH_Hash_Header_T *)((UI8_T *)wk + wk_len);
     ...
     */
    wk->data_record_desc.buffer =(char *)( (UI8_T *)wk + wk_len + header_len);
    ...
    wk->data_rec_ptr = (UI8_T *) ((UI8_T *)wk + wk_len + header_len);

    /* Init Query Group
     */
    {
        int i;
        dblist_buf = (L_DLST_Indexed_Dblist_T *) ((UI8_T *)wk + wk_len + header_len + rec_table_len);
...
BOOL_T L_HASH_DeleteRecord (L_HASH_Desc_T *desc, UI8_T  *user_rec, L_HASH_Index_T *index)
{
    ...
    if (hash_data->action != L_HASH_ACTION_DEL)
    {
        ...
        for (i = 0; (desc->element_of_query_group[i]> 0) && (i<L_HASH_MAX_QUERY_GROUP); i++)
        {
            ...
            dblist = (L_DLST_Indexed_Dblist_T *)((UI8_T *)(HASH_WK->query_group_ptr[i])+(element_index*sizeof(L_DLST_Indexed_Dblist_T)));
...
BOOL_T L_HASH_SearchByQueryGroup(L_HASH_Desc_T  *desc, UI32_T query_group,
                                 UI32_T query_element,void *cookie,
                                 UI32_T (*call_back) (L_HASH_Index_T index, void *cookie))
{
    L_DLST_Indexed_Dblist_T    *dblist;
    UI32_T                     ret;
    ...
    dblist = (L_DLST_Indexed_Dblist_T *)((UI8_T *)(HASH_WK->query_group_ptr[query_group])+(query_element*sizeof(L_DLST_Indexed_Dblist_T)));
...
BOOL_T L_HASH_SearchByQueryGroupAndDelete(L_HASH_Desc_T  *desc, UI32_T query_group, UI32_T query_element)
{
    ...
    cookie = (void *)desc;
    return L_HASH_SearchByQueryGroup(desc,query_group,query_element,cookie,L_HASH_DeleteQueryGroup_Callback);
}
 ...
 *          (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_GetRecordByIndex(L_HASH_Desc_T  *desc, L_HASH_Index_T index , UI8_T *user_rec,UI8_T *action)
{
...
void L_HASH_GetNRecord(L_HASH_Desc_T  *desc, UI32_T record_count)
{
    ...
    {
        hash_rec = (L_HASH_DataRecord_T *)((UI8_T *)HASH_WK->data_rec_ptr + (i*hash_rec_len));
 ...
 *          (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_GetRecordPtrByIndex(L_HASH_Desc_T  *desc, UI8_T **user_rec, L_HASH_Index_T index )
{
    L_HASH_DataRecord_T    *data;
 ...
 *          (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_GetRecordSyncValueByIndex(L_HASH_Desc_T  *desc, UI8_T *sync_value, L_HASH_Index_T index )
{
    L_HASH_DataRecord_T     *data;
 ...
 *         (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_SetRecordSyncValueByIndex(L_HASH_Desc_T  *desc, UI8_T sync_value, L_HASH_Index_T index )
{
    L_HASH_DataRecord_T     *data;
 ...
 *          (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_ShMem_GetRecordByIndex(L_HASH_ShMem_Desc_T  *desc, L_HASH_Index_T index , UI8_T *user_rec,UI8_T *action)
{
    L_HASH_ShMem_WorkSpace_T  *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T       *data;
 ...
 *          (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_ShMem_GetRecordPtrByIndex(L_HASH_ShMem_Desc_T  *desc, UI8_T **user_rec, L_HASH_Index_T index )
{
    L_HASH_ShMem_WorkSpace_T    *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T    *data;
 ...
 *          (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_ShMem_GetRecordSyncValueByIndex(L_HASH_ShMem_Desc_T  *desc, UI8_T *sync_value, L_HASH_Index_T index )
{
    L_HASH_ShMem_WorkSpace_T    *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T     *data;
 ...
 *         (ADD by MIKE_YEH)
 * -------------------------------------------------------------------------*/
void L_HASH_ShMem_SetRecordSyncValueByIndex(L_HASH_ShMem_Desc_T  *desc, UI8_T sync_value, L_HASH_Index_T index )
{
    L_HASH_ShMem_WorkSpace_T    *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T     *data;
    ...
    *hash_index = hash_bucket;
        ...
        current_rec_idx = ((L_HASH_DataRecord_T*)HASH_RECORD(current_rec_idx))->next_index)
    {
        ...
        if(!memcmp(current_rec_key, key, wk->total_key_len))
        {
            ...
            *table_idx = (L_HASH_Index_T)(((UI8_T *)data-(UI8_T *)(HASH_WK->data_rec_ptr)) / wk->hash_rec_len);
            return TRUE;
        }
    }
    return FALSE;
...
static BOOL_T L_HASH_LocateAndRemoveRecord(L_HASH_Desc_T  *desc, UI8_T *key, L_HASH_Index_T *table_idx)
{
        ...
        current_rec_idx=data_p->next_index)
    {
        ...
        *table_idx = ((UI8_T *)data_p-(UI8_T *)(wk->data_rec_ptr)) / wk->hash_rec_len;
        return TRUE;
    } /* end of if */
    return FALSE;
...
static BOOL_T L_HASH_AllocRecord (L_HASH_Desc_T *desc, L_HASH_Index_T *idx)
{
    ...
    *idx = ((UI8_T *)p-(UI8_T *)(wk->data_rec_ptr)) / wk->hash_rec_len;
...
static BOOL_T L_HASH_InsertQueryGroup(L_HASH_Desc_T *desc, UI8_T *user_rec, L_HASH_Index_T idx)
{
    ...
    for (i = 0; (desc->element_of_query_group[i]> 0) && (i<L_HASH_MAX_QUERY_GROUP); i++)
    {
        ...
        dblist = (L_DLST_Indexed_Dblist_T *)((UI8_T *)(wk->query_group_ptr[i])+(element_index*sizeof(L_DLST_Indexed_Dblist_T)));
...
static UI32_T L_HASH_DeleteQueryGroup_Callback(L_HASH_Index_T index,void *desc)
{
...
static BOOL_T L_HASH_SetHashRecord(L_HASH_Desc_T *desc, UI8_T *user_rec, UI8_T *key, UI32_T idx)
{
    ...
    /* BODY
     */
    p = (L_HASH_DataRecord_T*)((UI8_T *)(HASH_WK->data_rec_ptr) + (HASH_WK->hash_rec_len * idx));
...
BOOL_T L_HASH_UpdateQueryGroup(L_HASH_Desc_T *desc, L_HASH_Index_T idx, UI8_T *user_rec)
{
    ...
    for (i = 0; (desc->element_of_query_group[i]> 0) && (i<L_HASH_MAX_QUERY_GROUP); i++)
    {
        ...
        if (L_DLST_Indexed_Dblist_GetActualDblistDiscriptor(dblist, idx, &clone_dblist) == TRUE)
        {
            ...
            old_idx = ((UI8_T *)clone_dblist - (UI8_T *)dblist) / sizeof(L_DLST_Indexed_Dblist_T);
        ...
        clone_dblist = (L_DLST_Indexed_Dblist_T *)((UI8_T *)(dblist)+(element_index*sizeof(L_DLST_Indexed_Dblist_T)));
...
static BOOL_T L_HASH_DeriveRecordKey(L_HASH_Desc_T *desc, UI8_T *user_rec, UI8_T *key_buffer)
{
    ...
    {
        tmp_key_ptr = ((UI8_T *)user_rec + desc->key_offset[i]);
...
static BOOL_T L_HASH_ShMem_LocateRecord(L_HASH_ShMem_Desc_T  *desc, UI8_T *key, L_HASH_Index_T *hash_index, UI8_T **hash_data, L_HASH_Index_T *table_idx)
{
    ...
    *hash_index = hash_bucket;
        ...
        current_rec_idx = (SHMEM_HASH_RECORD(current_rec_idx))->next_index)
    {
        ...
        {
            *hash_data = (UI8_T *)data;
            *table_idx = (L_HASH_Index_T)(((UI8_T *)data-(UI8_T *)SHMEM_DATA_RECORD_PTR) / wk->hash_rec_len);
            return TRUE;
        }
    }
    return FALSE;
...
static BOOL_T L_HASH_ShMem_AllocRecord (L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T *idx)
{
    ...
    memset(p, 0, wk->hash_rec_len);
    *idx = ((UI8_T *)p-(UI8_T *)SHMEM_DATA_RECORD_PTR) / wk->hash_rec_len;
...
static UI32_T L_HASH_ShMem_DeleteQueryGroup_Callback(L_HASH_Index_T index,void *desc)
{
    L_HASH_ShMem_WorkSpace_T *wk = SHMEM_HASH_WK;
...
BOOL_T L_HASH_ShMem_UpdateQueryGroup(L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T idx, UI8_T *user_rec)
{
    ...
    for (i = 0; (desc->element_of_query_group[i]> 0) && (i<L_HASH_MAX_QUERY_GROUP); i++)
    {
        ...
        if (L_DLST_ShMem_Indexed_Dblist_GetActualDblistDiscriptor(dblist, idx, &clone_dblist) == TRUE)
        {
            ...
            old_idx = ((UI8_T *)clone_dblist - (UI8_T *)dblist) / sizeof(L_DLST_ShMem_Indexed_Dblist_T);
 ...
 * NOTES  : ADD by MIKE_YEH
 * -------------------------------------------------------------------------*/
BOOL_T L_HASH_ShMem_UpdateReservedState(L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T idx,UI8_T user_flag)
{
    L_HASH_ShMem_WorkSpace_T *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T *p;
 ...
 * NOTES  : ADD by MIKE_YEH
 * -------------------------------------------------------------------------*/
BOOL_T L_HASH_ShMem_ClearReservedState(L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T idx,UI8_T user_flag)
{
    L_HASH_ShMem_WorkSpace_T *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T *p;
 ...
 * NOTES  : ADD by MIKE_YEH
 * -------------------------------------------------------------------------*/
BOOL_T L_HASH_ShMem_GetReservedState(L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T idx,UI8_T *user_flag)
{
    L_HASH_ShMem_WorkSpace_T *wk = SHMEM_HASH_WK;
    L_HASH_DataRecord_T *p;
...
static void L_HASH_BD_WorkspaceStatus(void)
{
    ...
    for (i = 0; i < test_desc.nbr_of_hash_bucket; i++)
    {
            ...
            current_rec_idx = ((L_HASH_DataRecord_T*)HASH_RECORD(current_rec_idx))->next_index)
        {
            ...
            table_idx = (L_HASH_Index_T)(((UI8_T *)data-(UI8_T *)(wk->data_rec_ptr)) / wk->hash_rec_len);
