...
#define L_STACK_MAX_ELEMENT_NUMBER      8192
 ...
 *---------------------------------------------------------------------------------
 */
L_STACK_Hdlr_T L_STACK_Create(UI32_T size)
{
    ...
    return (L_STACK_Hdlr_T)stack_desc_p;
 ...
 *---------------------------------------------------------------------------------
 */
BOOL_T L_STACK_Destroy(L_STACK_Hdlr_T handler)
{
 ...
 *---------------------------------------------------------------------------------
 */
BOOL_T L_STACK_Pop(L_STACK_Hdlr_T handler, UI32_T *value)
{
    L_STACK_Desc_T *stack_p;
 ...
 *---------------------------------------------------------------------------------
 */
BOOL_T L_STACK_Push(L_STACK_Hdlr_T handler, UI32_T value)
{
    L_STACK_Desc_T *stack_p;
