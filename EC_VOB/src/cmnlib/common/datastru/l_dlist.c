 ...
 */
#define L_DLST_NULL_INDEX ((L_DLST_Index_T)-1)

/* DATA TYPE DECLARACTIONS
 */
typedef uintptr_t L_DLST_Id_T;
typedef struct L_DLST_Dblist_Element_S
{
    L_DLST_Index_T next_index;
    L_DLST_Index_T previous_index;
    L_DLST_Id_T dblist_id;  /* it's like a flag to show whether this element is used, it also saves the valid address of its descriptor L_DLST_Indexed_Dblist_T. */
 ...
 *
 */
BOOL_T L_DLST_Indexed_Dblist_Enqueue2Head(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    L_DLST_Dblist_Buffer_T *dblist;
    ...
    element[index].dblist_id = (L_DLST_Id_T)indexed_dblist;
 ...
 *
 */
BOOL_T L_DLST_Indexed_Dblist_Enqueue(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    L_DLST_Dblist_Element_T *element;
 ...
 */
BOOL_T L_DLST_Indexed_Dblist_GetFirstEntry(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T *index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    /* LOCAL VARIABLES DEFINITION
 ...
 *
 */
BOOL_T L_DLST_Indexed_Dblist_GetNextEntry(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T *index)
{
    ...
    L_DLST_Dblist_Buffer_T  *dblist;
    L_DLST_Dblist_Element_T *element;
    L_DLST_Index_T next_record_index;
    /* BODY
     */
    if (indexed_dblist == NULL ||
        indexed_dblist->dblist == NULL)
 ...
 *
 */
BOOL_T L_DLST_Indexed_Dblist_Dequeue(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T *index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    /* LOCAL VARIABLES DEFINITION
 ...
 *
 */
BOOL_T L_DLST_Indexed_Dblist_DeleteEntry (L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    /* LOCAL VARIABLES DEFINITION
...
UI32_T L_DLST_Indexed_Dblist_Search(L_DLST_Indexed_Dblist_T *indexed_dblist,
                                    void *cookie,
                                    UI32_T (*call_back) (L_DLST_Index_T index, void *cookie))
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    ...
    L_DLST_Dblist_Buffer_T  *dblist;
    L_DLST_Dblist_Element_T *element;
    L_DLST_Index_T record_index, next_record_index;
    /* BODY
     */
    if (indexed_dblist == NULL ||
        indexed_dblist->dblist == NULL)
...
BOOL_T L_DLST_Indexed_Dblist_SetEntryID(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index, UI32_T dlist_id)
{
 /* LOCAL CONSTANT DECLARATIONS
     */
    L_DLST_Dblist_Element_T *element;
...
BOOL_T L_DLST_Indexed_Dblist_GetEntryID(L_DLST_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index, UI32_T *dlist_id)
{
 /* LOCAL CONSTANT DECLARATIONS
     */
    L_DLST_Dblist_Element_T *element;
 ...
 *
 */
BOOL_T L_DLST_ShMem_Indexed_Dblist_Enqueue2Head(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
 ...
 *
 */
BOOL_T L_DLST_ShMem_Indexed_Dblist_Enqueue(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
 ...
 *      This API will not delete the first entry.
 */
BOOL_T L_DLST_ShMem_Indexed_Dblist_GetFirstEntry(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T *index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    /* LOCAL VARIABLES DEFINITION
 ...
 *
 */
BOOL_T L_DLST_ShMem_Indexed_Dblist_GetNextEntry(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T *index)
{
 ...
 *
 */
BOOL_T L_DLST_ShMem_Indexed_Dblist_Dequeue(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T *index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    /* LOCAL VARIABLES DEFINITION
 ...
 *
 */
BOOL_T L_DLST_ShMem_Indexed_Dblist_DeleteEntry (L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index)
{
    /* LOCAL CONSTANT DECLARATIONS
     */
    /* LOCAL VARIABLES DEFINITION
...
BOOL_T L_DLST_ShMem_Indexed_Dblist_SetEntryID(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index, UI32_T dlist_id)
{
 /* LOCAL CONSTANT DECLARATIONS
     */
    L_DLST_ShMem_Dblist_Element_T *element;
...
BOOL_T L_DLST_ShMem_Indexed_Dblist_GetEntryID(L_DLST_ShMem_Indexed_Dblist_T *indexed_dblist, L_DLST_Index_T index, UI32_T *dlist_id)
{
 /* LOCAL CONSTANT DECLARATIONS
     */
    L_DLST_ShMem_Dblist_Element_T *element;
...
static UI32_T L_DLIST_DEBUG_Callback(UI32_T idx, void *cookie)
{
