 ...
 */
#if !defined(SYS_ADPT_L_MSG_MESSAGE_SIZE_IN_UI32)
#define SYS_ADPT_L_MSG_MESSAGE_SIZE_IN_UI32 4
#endif
typedef struct L_MSG_Message_S
{
    UI32_T msg[SYS_ADPT_L_MSG_MESSAGE_SIZE_IN_UI32];
}L_MSG_Message_T;
 ...
 *          msg            -- the address of the msg buffer;
 *                            the size of the msg buffer must equal to
 *                            sizeof(L_MSG_Message_T)
 ...
 * INPUT:   priority_queue
 *          msg            -- the address of msg buffer;
 *                            the size of the msg buffer must equal to
 *                            sizeof(L_MSG_Message_T)
 *          priority       -- the address of msg priority
 * OUTPUT:  msg            -- the address of msg buffer
 *          priority       -- the msg priority
 * RETURN:  TRUE/FALSE
