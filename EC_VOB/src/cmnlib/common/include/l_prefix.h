...
#define IPV6_LOOPBACK(a)  (IPV6_ADDR_SAME(a, ((u_int8_t [IPV6_MAX_BYTELEN]) \
...
/* ref. BGP_MGR_PrefixToInaddr, for IPV6Z, the caller should assign correct zoneid again by itself */ 
