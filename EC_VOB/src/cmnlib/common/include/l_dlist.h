...
typedef SYS_ADPT_L_DLST_INDEX_T L_DLST_Index_T;
#else
typedef UI16_T L_DLST_Index_T;
#endif

typedef struct L_DLST_Indexed_Dblist_S
{
    L_DLST_Index_T  head_index;                   /* first index of this dblist        */
    L_DLST_Index_T  tail_index;                   /* last  index of this dblist        */
...
#define L_DLST_SHMEM_GET_WORKING_BUFFER_REQUIRED_SZ(max_number_of_items) \
    (offsetof(L_DLST_ShMem_Dblist_Buffer_T, element) + \
