 ...
 */
typedef L_DLST_Index_T L_HASH_Index_T;
...
typedef struct
{
    L_HASH_Index_T  nbr_of_hash_bucket;
    L_HASH_Index_T  nbr_of_rec;
 ...
 * -------------------------------------------------------------------------*/
BOOL_T L_HASH_ShMem_UpdateReservedState(L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T idx,UI8_T user_state);
 ...
 * NOTES  : ADD by MIKE_YEH
 * -------------------------------------------------------------------------*/
BOOL_T L_HASH_ShMem_GetReservedState(L_HASH_ShMem_Desc_T *desc, L_HASH_Index_T idx,UI8_T *user_state);
