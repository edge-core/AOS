...
#define L_ALIGN(addr,boundary) (  ( (uintptr_t)(addr) + (boundary) - 1) & ~((uintptr_t)(boundary) - 1))
 ...
 *  void  *L_CVRT_GET_PTR (void *base_p, ptrdiff_t offset)
 */
#define L_CVRT_GET_OFFSET(base_p, ptr) ((UI8_T*)(ptr) - (UI8_T*)(base_p))
#define L_CVRT_GET_PTR(base_p, offset) ((void *)((UI8_T *)(base_p) + (ptrdiff_t)(offset)))

/* Convert between integer type and pointer.
 */
#define L_CVRT_PTR_TO_INT(x) ((intptr_t)(x))
#define L_CVRT_PTR_TO_UINT(x) ((uintptr_t)(x))
#define L_CVRT_UINT_TO_PTR(x) ((void *)(uintptr_t)(x))
...
/*------------------------------------------------------------------------------
* Function : L_CVRT_16bitsInt_to_8bitsFloat
*------------------------------------------------------------------------------
...
*------------------------------------------------------------------------------*/
UI8_T L_CVRT_16bitsInt_to_8bitsFloat ( UI16_T value);


/*------------------------------------------------------------------------------
* Function : L_CVRT_32bitsInt_to_16BitsFloat
*------------------------------------------------------------------------------
...
*------------------------------------------------------------------------------*/
UI16_T L_CVRT_32bitsInt_to_16BitsFloat(UI32_T value);
