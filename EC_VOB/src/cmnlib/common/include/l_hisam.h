 ...
 */
UI32_T L_HISAM_Search (L_HISAM_Desc_T *desc, UI32_T kidx, UI8_T *key, UI32_T (*call_back) (void*rec), UI32_T count);
 ...
 *          2. Each time call back to call_back will modify desc->last_reference_record_index
 */
UI32_T L_HISAM_ShMem_Search (L_HISAM_ShMem_Desc_T *desc, UI32_T kidx, UI8_T *key, UI32_T (*call_back) (void*rec), UI32_T count);
