...
/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_LEtoh16
 *------------------------------------------------------------------------
 * FUNCTION: Convert 16-bit integer from LE(Little Endian) byte order to
 *           host byte order
 * INPUT   : 16-bit integer in LE byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 16-bit integer in host byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_LEtoh16(LE_int)  ((UI16_T)LE_int)

/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_Htole16
 *------------------------------------------------------------------------
 * FUNCTION: Convert 16-bit integer from host byte order to
 *           LE(Little Endian) byte order
 * INPUT   : 16-bit integer in host byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 16-bit integer in LE byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_Htole16(host_int)  ((UI16_T)host_int)
 ...
 *------------------------------------------------------------------------
 * FUNCTION: Convert 32-bit integer from network byte order to host byte order
...
/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_LEtoh32
 *------------------------------------------------------------------------
 * FUNCTION: Convert 32-bit integer from LE(Little Endian) byte order to
 *           host byte order
 * INPUT   : 32-bit integer in LE byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 32-bit integer in host byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_LEtoh32(LE_int) ((UI32_T)LE_int)

/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_Htole32
 *------------------------------------------------------------------------
 * FUNCTION: Convert 32-bit integer from host byte order to
 *           LE(Little Endian) byte order
 * INPUT   : 32-bit integer in host byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 32-bit integer in LE byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_Htole32(host_int) ((UI32_T)host_int)
...
/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_LEtoh64
 *------------------------------------------------------------------------
 * FUNCTION: Convert 64-bit integer from LE(Little Endian) byte order to
 *           host byte order
 * INPUT   : 64-bit integer in LE byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 64-bit integer in host byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_LEtoh64(LE_int) ((UI64_T)LE_int)

/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_Htole64
 *------------------------------------------------------------------------
 * FUNCTION: Convert 64-bit integer from host byte order to
 *           LE(Little Endian) byte order
 * INPUT   : 64-bit integer in host byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 64-bit integer in LE byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_Htole64(host_int) ((UI64_T)host_int)
...
#else /* #if (SYS_HWCFG_LITTLE_ENDIAN_CPU==TRUE) */
/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_Hton16
 *------------------------------------------------------------------------
 * FUNCTION: Convert 16-bit integer from host byte order to network byte order
 ...
 * ROUTINE NAME - L_STDLIB_LEtoh16
 *------------------------------------------------------------------------
 * FUNCTION: Convert 16-bit integer from LE(Little Endian) order to host
 *           byte order
 * INPUT   : 16-bit integer in LE byte order (little-endian)
 * OUTPUT  : None
 * RETURN  : 16-bit integer in host byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_LEtoh16(LE_int)  (L_STDLIB_Swap16((UI16_T)LE_int))

/*------------------------------------------------------------------------
 * ROUTINE NAME - L_STDLIB_Htole16
 *------------------------------------------------------------------------
 * FUNCTION: Convert 16-bit integer from host order to LE(Little Endian)
 *           byte order
 * INPUT   : 16-bit integer in host byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 16-bit integer in LE byte order (little-endian)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_Htole16(host_int)  (L_STDLIB_Swap16((UI16_T)host_int))
 ...
 * FUNCTION: Convert 32-bit integer from LE(Little Endian) byte order to
 *           host byte order
 * INPUT   : 32-bit integer in LE byte order (little-endian)
 * OUTPUT  : None
 * RETURN  : 32-bit integer in host byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_LEtoh32(LE_int) (L_STDLIB_Swap32((UI32_T)LE_int))
 ...
 * INPUT   : 32-bit integer in host byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 32-bit integer in LE byte order (little-endian)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_Htole32(host_int) (L_STDLIB_Swap32((UI32_T)host_int))
 ...
 * FUNCTION: Convert 64-bit integer from LE(Little Endian) byte order to
 *           host byte order
 * INPUT   : 64-bit integer in LE(Little Endian) byte order (little-endian)
 * OUTPUT  : None
 * RETURN  : 64-bit integer in host byte order (usable as integer)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_LEtoh64(LE_int) (L_STDLIB_Swap64((UI64_T)LE_int))
 ...
 * INPUT   : 64-bit integer in host byte order (usable as integer)
 * OUTPUT  : None
 * RETURN  : 64-bit integer in LE(Little Endian) byte order (little-endian)
 * NOTE    :
 *------------------------------------------------------------------------*/
#define L_STDLIB_HtoLE64(host_int) (L_STDLIB_Swap64((UI64_T)host_int))
...
#endif /* end of #if (SYS_HWCFG_LITTLE_ENDIAN_CPU==TRUE) */
