...
#define SYSMOD_LIST(_) \
    ...
    _(SYS_MODULE_PBRCFG,                "PBR Config")       \
    ...
    _(SYS_MODULE_NTP,                   "NTP")              \
    _(SYS_MODULE_BGP,                   "BGP")              \
    _(SYS_MODULE_NSM_POLICY,            "NSM Policy")       \
    _(SYS_MODULE_UDLD,                  "UDLD")             \
    _(SYS_MODULE_DYING_GASP,            "Dying Gasp")       \
    _(SYS_MODULE_PTP,                   "PTP")              \
    _(SYS_MODULE_DEBUG,                 "Debug")            \
    _(SYS_MODULE_NDSNP,                 "NDSNP")            \
    _(SYS_MODULE_IP6SG,                 "IP6SG")            \
    _(SYS_MODULE_SYNCE,                 "SyncE")            \
    _(SYS_MODULE_ELPS,                  "ELPS")             \
    _(SYS_MODULE_PFC,                   "PFC")              \
    _(SYS_MODULE_DCBX,                  "DCBX")             \
    _(SYS_MODULE_CN,                    "CN")               \
    _(SYS_MODULE_ETS,                   "ETS")              \
    _(SYS_MODULE_AF,                    "AppFilter")        \
    _(SYS_MODULE_IPSG,                  "IPSG")             \
    _(SYS_MODULE_MLAG,                  "MLAG")             \
    _(SYS_MODULE_OF,                    "OpenFlow")         \
    _(SYS_MODULE_DEV_OFDRV,             "OpenFlow Driver")  \
    _(SYS_MODULE_VXLAN,                 "VXLAN")            \
    _(SYS_MODULE_CMGR,                  "CMGR")             \
    _(SYS_MODULE_OVSVTEP,               "OVSVTEP")          \
