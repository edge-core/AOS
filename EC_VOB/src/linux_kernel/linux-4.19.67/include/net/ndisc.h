...
#if 1 /* Accton Patch */
extern int neigh_hit_by_amtrl3(struct net_device *dev, struct in6_addr *addr, const u8 *lladdr);
extern int neigh_nd_lookup(struct net_device *dev, struct in6_addr *addr, u8 *lladdr, u8 *state);
#endif
