/*
 * I2C multiplexer driver for accton as5812 CPLD
 *
...
static int accton_i2c_cpld_mux_select_chan(struct i2c_mux_core *muxc, u32 chan)
{
...
static int accton_i2c_cpld_mux_deselect_mux(struct i2c_mux_core *muxc, u32 chan)
{
	struct accton_i2c_cpld_mux *data = i2c_mux_priv(muxc);
	struct i2c_client *client = data->client;
			 ...
			 const struct i2c_device_id *id)
{
	...
	muxc = i2c_mux_alloc(adap, &client->dev, ACCTON_I2C_CPLD_MUX_MAX_NCHANS, sizeof(*data), 0,
