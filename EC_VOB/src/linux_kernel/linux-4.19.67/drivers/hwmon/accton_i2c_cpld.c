...
static struct dmi_system_id as7712_16x_dmi_table[] = {
        {
                .ident = "Accton AS7712-16X",
                .matches = {
                        DMI_MATCH(DMI_BOARD_VENDOR, "Accton"),
                        DMI_MATCH(DMI_PRODUCT_NAME, "AS7712-16X"),
                },
        }
};

int platform_accton_as7712_16x(void)
{
        return dmi_check_system(as7712_16x_dmi_table);
}
EXPORT_SYMBOL(platform_accton_as7712_16x);
