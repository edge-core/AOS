...
static int as5512_54x_psu_model_name_get(struct device *dev);
             ...
             char *buf)
{
    ...
    if (as5512_54x_psu_model_name_get(dev) < 0) {
        return -ENXIO;
    }
...
static const struct i2c_device_id as5512_54x_psu_id[] = {
    { "as5512_54x_psu1", as5512_54x_psu1 },
    { "as5512_54x_psu2", as5512_54x_psu2 },
    {}
};
...
static int as5512_54x_psu_model_name_get(struct device *dev)
{
    ...
    for (i = 0; i < ARRAY_SIZE(models); i++) {
        ...
        status = as5512_54x_psu_read_block(client, models[i].offset,
...
static struct as5512_54x_psu_data *as5512_54x_psu_update_device(struct device *dev)
{
    ...
    if (time_after(jiffies, data->last_updated + HZ + HZ / 2)
        ...
        /* Read psu status */
        status = as5512_54x_cpld_read(PSU_STATUS_I2C_ADDR, PSU_STATUS_I2C_REG_OFFSET);
