...
insmod ${KMOD_PREFIX}/kernel/drivers/misc/eeprom/accton_as5812_54t_sfp.ko
insmod ${KMOD_PREFIX}/kernel/drivers/hwmon/accton_as5812_54t_fan.ko
insmod ${KMOD_PREFIX}/kernel/drivers/hwmon/accton_as5812_54t_psu.ko
insmod ${KMOD_PREFIX}/kernel/drivers/leds/leds-accton_as5812_54t.ko
...
echo as5812_54t_qsfp49 0x51 > /sys/bus/i2c/devices/i2c-4/new_device
echo as5812_54t_qsfp50 0x51 > /sys/bus/i2c/devices/i2c-6/new_device
echo as5812_54t_qsfp51 0x51 > /sys/bus/i2c/devices/i2c-3/new_device
echo as5812_54t_qsfp52 0x51 > /sys/bus/i2c/devices/i2c-5/new_device
echo as5812_54t_qsfp53 0x51 > /sys/bus/i2c/devices/i2c-7/new_device
echo as5812_54t_qsfp54 0x51 > /sys/bus/i2c/devices/i2c-2/new_device
